...
from ours.src.beam import Beams, ActionInfo
from ours.src.dataset import Batch
from ours.src.models import nn_utils
from ours.src.models.basic_model import BasicModel
from ours.src.models.pointer_net import PointerNet
from ours.src.rule import semQL as define_rule
...
class IRNet(BasicModel):
    def __init__(self, args, grammar):
        ...
        self.encoder_lstm = nn.LSTM(
            args.embed_size, args.hidden_size // 2, bidirectional=True, batch_first=True
        )
        ...
        self.read_out_act = (
            F.tanh if args.readout == "non_linear" else nn_utils.identity
        )
