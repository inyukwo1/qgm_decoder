...
def init_arg_parser():
    ...
    arg_parser.add_argument(
        "--lr_scheduler", default=True, help="use learning rate scheduler"
    )
    arg_parser.add_argument(
    ...
    arg_parser.add_argument(
        "--loss_epoch_threshold", default=50, type=int, help="loss epoch threshold"
    )
    arg_parser.add_argument(
    ...
    arg_parser.add_argument(
        "--sentence_features", default=True, help="use sentence features"
    )
    arg_parser.add_argument(
        "--model_name",
    ...
    arg_parser.add_argument(
        "--glove_embed_path", default="./data/glove.42B.300d.txt", type=str
    )
    ...
    arg_parser.add_argument(
        "--hidden_size", default=300, type=int, help="size of LSTM hidden states"
    )
    arg_parser.add_argument(
        "--att_vec_size", default=300, type=int, help="size of attentional vector"
    )
