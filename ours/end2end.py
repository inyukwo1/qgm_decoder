...
class End2EndOurs(End2End):
    def prepare_model(self, dataset):
        ...
        for one_schema in val_table_data:
            ...
            schema_dict[one_schema]["only_cnames"] = [c_name.lower() for tid, c_name in
                                                               val_table_data[one_schema]["column_names_original"]]
        ...
        for db_id in val_table_data:
            if db_id not in self.db_values:
                ...
                conn = sqlite3.connect("data/{}/database/{}/{}.sqlite".format(dataset, db_id, db_id))
