...
export const select_styles = {
    ...
    option: (base, state) => ({
        ...base,
        backgroundColor: state.isSelected ? '#1c52a3' : state.isFocused ? '#e3edfc' : 'white',
    }),
...
export const models = [
    ...
    { label: 'IRNet-improved', value: 'irnet-improved' },
]
...
export const db_ids = [
    ...
    { label: 'Student transcripts tracking', value: 'student_transcripts_tracking', img: student_transcripts_tracking },
    { label: 'Singer', value: 'singer', img: singer },
    { label: 'Cre Doc Template Mgt', value: 'cre_Doc_Template_Mgt', img: cre_Doc_Template_Mgt },
    { label: 'World', value: 'world_1', img: world_1 },
    { label: 'Employee hire evaluation', value: 'employee_hire_evaluation', img: employee_hire_evaluation },
    { label: 'Network', value: 'network_1', img: network_1 },
    { label: 'Poker player', value: 'poker_player', img: poker_player },
    { label: 'Real estate properties', value: 'real_estate_properties', img: real_estate_properties },
...
export const styled_db_ids = [
    { label: 'Dog kennels', value: { label: 'Dog kennels', value: 'dog_kennels', img: dog_kennels } },
    { label: 'Flight', value: { label: 'Flight', value: 'flight_2', img: flight_2 } },
    { label: 'Pets', value: { label: 'Pets', value: 'pets_1', img: pets_1 } },
    { label: 'Concert singer', value: { label: 'Concert singer', value: 'concert_singer', img: concert_singer } },
    { label: 'Museum visit', value: { label: 'Museum visit', value: 'museum_visit', img: museum_visit } },
    { label: 'Battle death', value: { label: 'Battle death', value: 'battle_death', img: battle_death } },
    { label: 'Student transcripts tracking', value: { label: 'Student transcripts tracking', value: 'student_transcripts_tracking', img: student_transcripts_tracking } },
    { label: 'Singer', value: { label: 'Singer', value: 'singer', img: singer } },
    { label: 'Cre Doc Template Mgt', value: { label: 'Cre Doc Template Mgt', value: 'cre_Doc_Template_Mgt', img: cre_Doc_Template_Mgt } },
    { label: 'World', value: { label: 'World', value: 'world_1', img: world_1 } },
    { label: 'Employee hire evaluation', value: { label: 'Employee hire evaluation', value: 'employee_hire_evaluation', img: employee_hire_evaluation } },
    { label: 'Network', value: { label: 'Network', value: 'network_1', img: network_1 } },
    { label: 'Poker player', value: { label: 'Poker player', value: 'poker_player', img: poker_player } },
    { label: 'Real estate properties', value: { label: 'Real estate properties', value: 'real_estate_properties', img: real_estate_properties } },
    { label: 'Course teach', value: { label: 'Course teach', value: 'course_teach', img: course_teach } },
    { label: 'Voter', value: { label: 'Voter', value: 'voter_1', img: voter_1 } },
    { label: 'Wta', value: { label: 'Wta', value: 'wta_1', img: wta_1 } },
    { label: 'Orchestra', value: { label: 'Orchestra', value: 'orchestra', img: orchestra } },
