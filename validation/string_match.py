...
def write_file(rewrite_query_file, info_file, read_gold_query_files, schema_filename, dataset, acc_name='accurate_qm_db2'):
            ...
            with open(write_result_file, 'w') as f_result:
                ...
                for key in keys:
                    ...
                    if acc_qm:
                        ...
                        print('{}'.format('\t'.join([dataset, sys, category, idx, '', gen_pretty, gold_pretty, sql_cosette, gold_query, nl])))
    return write_files
...
if __name__ == '__main__':
    ...
    if info_file in info_files \
            or query_file in query_files:
        accuracy_filenames = write_file(query_file, info_file, gold_query_files, schema_filename, dataset)
    else:
        print("No file(s)")
