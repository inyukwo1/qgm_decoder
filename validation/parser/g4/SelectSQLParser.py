...
class SelectSQLParser(Parser):
    ...
    class UnionSelectContext(SelectStatementContext):
        ...
        ):  # actually a SelectSQLParser.SelectStatementContext
        ...
        def querySpecification(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.QuerySpecificationContext, i
                )
        ...
        def unionStatement(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.UnionStatementContext, i
                )
    ...
    class UnionParenthesisSelectContext(SelectStatementContext):
        ...
        def queryExpression(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.QueryExpressionContext, i
                )

        def unionParenthesis(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.UnionParenthesisContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.UnionParenthesisContext, i
                )
    ...
    class SimpleSelectContext(SelectStatementContext):
        ...
        def querySpecification(self):
            return self.getTypedRuleContext(
                SelectSQLParser.QuerySpecificationContext, 0
            )
            ...
            if la_ == 1:
                ...
                if _la == SelectSQLParser.UNION:
                    ...
                    if _la == SelectSQLParser.ALL or _la == SelectSQLParser.DISTINCT:
                        ...
                        _la = self._input.LA(1)
                        if not (
                            _la == SelectSQLParser.ALL
                            or _la == SelectSQLParser.DISTINCT
                        ):
    ...
    class OrderByClauseContext(ParserRuleContext):
        ...
        def orderByExpression(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.OrderByExpressionContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.OrderByExpressionContext, i
                )
    ...
    class TableSourceNestedContext(TableSourceContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.TableSourceContext
            super().__init__(parser)
            self.copyFrom(ctx)
            ...
            if la_ == 1:
                ...
                while (
                    ...
                    and (
                        (1 << (_la - 30))
                        & (
                            (1 << (SelectSQLParser.CROSS - 30))
                            | (1 << (SelectSQLParser.INNER - 30))
                            | (1 << (SelectSQLParser.JOIN - 30))
                            | (1 << (SelectSQLParser.LEFT - 30))
                        )
                    )
                    != 0
                ) or (
                    ...
                    and (
                        (1 << (_la - 96))
                        & (
                            (1 << (SelectSQLParser.NATURAL - 96))
                            | (1 << (SelectSQLParser.RIGHT - 96))
                            | (1 << (SelectSQLParser.STRAIGHT_JOIN - 96))
                        )
                    )
                    != 0
                ):
    ...
    class SubqueryTableItemContext(TableSourceItemContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.TableSourceItemContext
            super().__init__(parser)
    ...
    def indexHint(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.FORCE
                or _la == SelectSQLParser.IGNORE
                or _la == SelectSQLParser.USE
            ):
    ...
    class InnerJoinContext(JoinPartContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.JoinPartContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    def joinPart(self):
        ...
        try:
            ...
            token = self._input.LA(1)
            if token in [
                SelectSQLParser.CROSS,
                SelectSQLParser.INNER,
                SelectSQLParser.JOIN,
            ]:
                ...
                if _la == SelectSQLParser.CROSS or _la == SelectSQLParser.INNER:
                    ...
                    _la = self._input.LA(1)
                    if not (
                        _la == SelectSQLParser.CROSS or _la == SelectSQLParser.INNER
                    ):
                ...
                if token in [SelectSQLParser.ON]:
                    ...
                    SelectSQLParser.AS,
                    SelectSQLParser.CROSS,
                    SelectSQLParser.GROUP,
                    SelectSQLParser.HAVING,
                    SelectSQLParser.INNER,
                    SelectSQLParser.JOIN,
                    SelectSQLParser.LEFT,
                    SelectSQLParser.LIMIT,
                    SelectSQLParser.NATURAL,
                    SelectSQLParser.ORDER,
                    SelectSQLParser.RIGHT,
                    SelectSQLParser.STRAIGHT_JOIN,
                    SelectSQLParser.UNION,
                    SelectSQLParser.WHERE,
                    SelectSQLParser.DATE,
                    SelectSQLParser.TIME,
                    SelectSQLParser.TIMESTAMP,
                    SelectSQLParser.DATETIME,
                    SelectSQLParser.YEAR,
                    SelectSQLParser.TEXT,
                    SelectSQLParser.ENUM,
                    SelectSQLParser.COUNT,
                    SelectSQLParser.POSITION,
                    SelectSQLParser.ACCOUNT,
                    SelectSQLParser.ACTION,
                    SelectSQLParser.AFTER,
                    SelectSQLParser.AGGREGATE,
                    SelectSQLParser.ALGORITHM,
                    SelectSQLParser.ANY,
                    SelectSQLParser.AT,
                    SelectSQLParser.AUTHORS,
                    SelectSQLParser.AUTOCOMMIT,
                    SelectSQLParser.AUTOEXTEND_SIZE,
                    SelectSQLParser.AUTO_INCREMENT,
                    SelectSQLParser.AVG_ROW_LENGTH,
                    SelectSQLParser.BEGIN,
                    SelectSQLParser.BINLOG,
                    SelectSQLParser.BIT,
                    SelectSQLParser.BLOCK,
                    SelectSQLParser.BOOL,
                    SelectSQLParser.BOOLEAN,
                    SelectSQLParser.BTREE,
                    SelectSQLParser.CASCADED,
                    SelectSQLParser.CHAIN,
                    SelectSQLParser.CHANNEL,
                    SelectSQLParser.CHECKSUM,
                    SelectSQLParser.CIPHER,
                    SelectSQLParser.CLIENT,
                    SelectSQLParser.COALESCE,
                    SelectSQLParser.CODE,
                    SelectSQLParser.COLUMNS,
                    SelectSQLParser.COLUMN_FORMAT,
                    SelectSQLParser.COMMENT,
                    SelectSQLParser.COMMIT,
                    SelectSQLParser.COMPACT,
                    SelectSQLParser.COMPLETION,
                    SelectSQLParser.COMPRESSED,
                    SelectSQLParser.COMPRESSION,
                    SelectSQLParser.CONCURRENT,
                    SelectSQLParser.CONNECTION,
                    SelectSQLParser.CONSISTENT,
                    SelectSQLParser.CONTAINS,
                    SelectSQLParser.CONTEXT,
                    SelectSQLParser.CONTRIBUTORS,
                    SelectSQLParser.COPY,
                    SelectSQLParser.CPU,
                    SelectSQLParser.DATA,
                    SelectSQLParser.DATAFILE,
                    SelectSQLParser.DEALLOCATE,
                    SelectSQLParser.DEFAULT_AUTH,
                    SelectSQLParser.DEFINER,
                    SelectSQLParser.DELAY_KEY_WRITE,
                    SelectSQLParser.DIRECTORY,
                    SelectSQLParser.DISABLE,
                    SelectSQLParser.DISCARD,
                    SelectSQLParser.DISK,
                    SelectSQLParser.DO,
                    SelectSQLParser.DUMPFILE,
                    SelectSQLParser.DUPLICATE,
                    SelectSQLParser.DYNAMIC,
                    SelectSQLParser.ENABLE,
                    SelectSQLParser.ENCRYPTION,
                    SelectSQLParser.ENDS,
                    SelectSQLParser.ENGINE,
                    SelectSQLParser.ENGINES,
                    SelectSQLParser.ERROR,
                    SelectSQLParser.ERRORS,
                    SelectSQLParser.ESCAPE,
                    SelectSQLParser.EVEN,
                    SelectSQLParser.EVENT,
                    SelectSQLParser.EVENTS,
                    SelectSQLParser.EVERY,
                    SelectSQLParser.EXCHANGE,
                    SelectSQLParser.EXCLUSIVE,
                    SelectSQLParser.EXPIRE,
                    SelectSQLParser.EXTENT_SIZE,
                    SelectSQLParser.FAULTS,
                    SelectSQLParser.FIELDS,
                    SelectSQLParser.FILE_BLOCK_SIZE,
                    SelectSQLParser.FILTER,
                    SelectSQLParser.FIRST,
                    SelectSQLParser.FIXED,
                    SelectSQLParser.FOLLOWS,
                    SelectSQLParser.FULL,
                    SelectSQLParser.FUNCTION,
                    SelectSQLParser.GLOBAL,
                    SelectSQLParser.GRANTS,
                    SelectSQLParser.GROUP_REPLICATION,
                    SelectSQLParser.HASH,
                    SelectSQLParser.HOST,
                    SelectSQLParser.IDENTIFIED,
                    SelectSQLParser.IGNORE_SERVER_IDS,
                    SelectSQLParser.IMPORT,
                    SelectSQLParser.INDEXES,
                    SelectSQLParser.INITIAL_SIZE,
                    SelectSQLParser.INPLACE,
                    SelectSQLParser.INSERT_METHOD,
                    SelectSQLParser.INSTANCE,
                    SelectSQLParser.INVOKER,
                    SelectSQLParser.IO,
                    SelectSQLParser.IO_THREAD,
                    SelectSQLParser.IPC,
                    SelectSQLParser.ISOLATION,
                    SelectSQLParser.ISSUER,
                    SelectSQLParser.KEY_BLOCK_SIZE,
                    SelectSQLParser.LANGUAGE,
                    SelectSQLParser.LAST,
                    SelectSQLParser.LEAVES,
                    SelectSQLParser.LESS,
                    SelectSQLParser.LEVEL,
                    SelectSQLParser.LIST,
                    SelectSQLParser.LOCAL,
                    SelectSQLParser.LOGFILE,
                    SelectSQLParser.LOGS,
                    SelectSQLParser.MASTER,
                    SelectSQLParser.MASTER_AUTO_POSITION,
                    SelectSQLParser.MASTER_CONNECT_RETRY,
                    SelectSQLParser.MASTER_DELAY,
                    SelectSQLParser.MASTER_HEARTBEAT_PERIOD,
                    SelectSQLParser.MASTER_HOST,
                    SelectSQLParser.MASTER_LOG_FILE,
                    SelectSQLParser.MASTER_LOG_POS,
                    SelectSQLParser.MASTER_PASSWORD,
                    SelectSQLParser.MASTER_PORT,
                    SelectSQLParser.MASTER_RETRY_COUNT,
                    SelectSQLParser.MASTER_SSL,
                    SelectSQLParser.MASTER_SSL_CA,
                    SelectSQLParser.MASTER_SSL_CAPATH,
                    SelectSQLParser.MASTER_SSL_CERT,
                    SelectSQLParser.MASTER_SSL_CIPHER,
                    SelectSQLParser.MASTER_SSL_CRL,
                    SelectSQLParser.MASTER_SSL_CRLPATH,
                    SelectSQLParser.MASTER_SSL_KEY,
                    SelectSQLParser.MASTER_TLS_VERSION,
                    SelectSQLParser.MASTER_USER,
                    SelectSQLParser.MAX_CONNECTIONS_PER_HOUR,
                    SelectSQLParser.MAX_QUERIES_PER_HOUR,
                    SelectSQLParser.MAX_ROWS,
                    SelectSQLParser.MAX_SIZE,
                    SelectSQLParser.MAX_UPDATES_PER_HOUR,
                    SelectSQLParser.MAX_USER_CONNECTIONS,
                    SelectSQLParser.MERGE,
                    SelectSQLParser.MID,
                    SelectSQLParser.MIGRATE,
                    SelectSQLParser.MIN_ROWS,
                    SelectSQLParser.MODIFY,
                    SelectSQLParser.MUTEX,
                    SelectSQLParser.MYSQL,
                    SelectSQLParser.NAME,
                    SelectSQLParser.NAMES,
                    SelectSQLParser.NCHAR,
                    SelectSQLParser.NEVER,
                    SelectSQLParser.NO,
                    SelectSQLParser.NODEGROUP,
                    SelectSQLParser.NONE,
                    SelectSQLParser.OFFLINE,
                    SelectSQLParser.OFFSET,
                    SelectSQLParser.OJ,
                    SelectSQLParser.OLD_PASSWORD,
                    SelectSQLParser.ONE,
                    SelectSQLParser.ONLINE,
                    SelectSQLParser.ONLY,
                    SelectSQLParser.OPTIMIZER_COSTS,
                    SelectSQLParser.OPTIONS,
                    SelectSQLParser.OWNER,
                    SelectSQLParser.PACK_KEYS,
                    SelectSQLParser.PAGE,
                    SelectSQLParser.PARSER,
                    SelectSQLParser.PARTIAL,
                    SelectSQLParser.PARTITIONING,
                    SelectSQLParser.PARTITIONS,
                    SelectSQLParser.PASSWORD,
                    SelectSQLParser.PHASE,
                    SelectSQLParser.PLUGIN_DIR,
                    SelectSQLParser.PLUGINS,
                    SelectSQLParser.PORT,
                    SelectSQLParser.PRECEDES,
                    SelectSQLParser.PREPARE,
                    SelectSQLParser.PRESERVE,
                    SelectSQLParser.PREV,
                    SelectSQLParser.PROCESSLIST,
                    SelectSQLParser.PROFILE,
                    SelectSQLParser.PROFILES,
                    SelectSQLParser.PROXY,
                    SelectSQLParser.QUERY,
                    SelectSQLParser.QUICK,
                    SelectSQLParser.REBUILD,
                    SelectSQLParser.RECOVER,
                    SelectSQLParser.REDO_BUFFER_SIZE,
                    SelectSQLParser.REDUNDANT,
                    SelectSQLParser.RELAY_LOG_FILE,
                    SelectSQLParser.RELAY_LOG_POS,
                    SelectSQLParser.RELAYLOG,
                    SelectSQLParser.REMOVE,
                    SelectSQLParser.REORGANIZE,
                    SelectSQLParser.REPAIR,
                    SelectSQLParser.REPLICATE_DO_DB,
                    SelectSQLParser.REPLICATE_DO_TABLE,
                    SelectSQLParser.REPLICATE_IGNORE_DB,
                    SelectSQLParser.REPLICATE_IGNORE_TABLE,
                    SelectSQLParser.REPLICATE_REWRITE_DB,
                    SelectSQLParser.REPLICATE_WILD_DO_TABLE,
                    SelectSQLParser.REPLICATE_WILD_IGNORE_TABLE,
                    SelectSQLParser.REPLICATION,
                    SelectSQLParser.RESUME,
                    SelectSQLParser.RETURNS,
                    SelectSQLParser.ROLLBACK,
                    SelectSQLParser.ROLLUP,
                    SelectSQLParser.ROTATE,
                    SelectSQLParser.ROW,
                    SelectSQLParser.ROWS,
                    SelectSQLParser.ROW_FORMAT,
                    SelectSQLParser.SAVEPOINT,
                    SelectSQLParser.SCHEDULE,
                    SelectSQLParser.SECURITY,
                    SelectSQLParser.SERVER,
                    SelectSQLParser.SESSION,
                    SelectSQLParser.SHARE,
                    SelectSQLParser.SHARED,
                    SelectSQLParser.SIGNED,
                    SelectSQLParser.SIMPLE,
                    SelectSQLParser.SLAVE,
                    SelectSQLParser.SNAPSHOT,
                    SelectSQLParser.SOCKET,
                    SelectSQLParser.SOME,
                    SelectSQLParser.SOUNDS,
                    SelectSQLParser.SOURCE,
                    SelectSQLParser.SQL_AFTER_GTIDS,
                    SelectSQLParser.SQL_AFTER_MTS_GAPS,
                    SelectSQLParser.SQL_BEFORE_GTIDS,
                    SelectSQLParser.SQL_BUFFER_RESULT,
                    SelectSQLParser.SQL_CACHE,
                    SelectSQLParser.SQL_NO_CACHE,
                    SelectSQLParser.SQL_THREAD,
                    SelectSQLParser.START,
                    SelectSQLParser.STARTS,
                    SelectSQLParser.STATS_AUTO_RECALC,
                    SelectSQLParser.STATS_PERSISTENT,
                    SelectSQLParser.STATS_SAMPLE_PAGES,
                    SelectSQLParser.STATUS,
                    SelectSQLParser.STOP,
                    SelectSQLParser.STORAGE,
                    SelectSQLParser.STRING,
                    SelectSQLParser.SUBJECT,
                    SelectSQLParser.SUBPARTITION,
                    SelectSQLParser.SUBPARTITIONS,
                    SelectSQLParser.SUSPEND,
                    SelectSQLParser.SWAPS,
                    SelectSQLParser.SWITCHES,
                    SelectSQLParser.TABLESPACE,
                    SelectSQLParser.TEMPORARY,
                    SelectSQLParser.TEMPTABLE,
                    SelectSQLParser.THAN,
                    SelectSQLParser.TRANSACTION,
                    SelectSQLParser.TRUNCATE,
                    SelectSQLParser.UNDEFINED,
                    SelectSQLParser.UNDOFILE,
                    SelectSQLParser.UNDO_BUFFER_SIZE,
                    SelectSQLParser.UNKNOWN,
                    SelectSQLParser.UPGRADE,
                    SelectSQLParser.USER,
                    SelectSQLParser.VALIDATION,
                    SelectSQLParser.VALUE,
                    SelectSQLParser.VARIABLES,
                    SelectSQLParser.VIEW,
                    SelectSQLParser.WAIT,
                    SelectSQLParser.WARNINGS,
                    SelectSQLParser.WITHOUT,
                    SelectSQLParser.WORK,
                    SelectSQLParser.WRAPPER,
                    SelectSQLParser.X509,
                    SelectSQLParser.XA,
                    SelectSQLParser.XML,
                    SelectSQLParser.QUARTER,
                    SelectSQLParser.MONTH,
                    SelectSQLParser.DAY,
                    SelectSQLParser.HOUR,
                    SelectSQLParser.MINUTE,
                    SelectSQLParser.WEEK,
                    SelectSQLParser.SECOND,
                    SelectSQLParser.MICROSECOND,
                    SelectSQLParser.TABLES,
                    SelectSQLParser.ROUTINE,
                    SelectSQLParser.EXECUTE,
                    SelectSQLParser.FILE,
                    SelectSQLParser.PROCESS,
                    SelectSQLParser.RELOAD,
                    SelectSQLParser.SHUTDOWN,
                    SelectSQLParser.SUPER,
                    SelectSQLParser.PRIVILEGES,
                    SelectSQLParser.ARMSCII8,
                    SelectSQLParser.ASCII,
                    SelectSQLParser.BIG5,
                    SelectSQLParser.CP1250,
                    SelectSQLParser.CP1251,
                    SelectSQLParser.CP1256,
                    SelectSQLParser.CP1257,
                    SelectSQLParser.CP850,
                    SelectSQLParser.CP852,
                    SelectSQLParser.CP866,
                    SelectSQLParser.CP932,
                    SelectSQLParser.DEC8,
                    SelectSQLParser.EUCJPMS,
                    SelectSQLParser.EUCKR,
                    SelectSQLParser.GB2312,
                    SelectSQLParser.GBK,
                    SelectSQLParser.GEOSTD8,
                    SelectSQLParser.GREEK,
                    SelectSQLParser.HEBREW,
                    SelectSQLParser.HP8,
                    SelectSQLParser.KEYBCS2,
                    SelectSQLParser.KOI8R,
                    SelectSQLParser.KOI8U,
                    SelectSQLParser.LATIN1,
                    SelectSQLParser.LATIN2,
                    SelectSQLParser.LATIN5,
                    SelectSQLParser.LATIN7,
                    SelectSQLParser.MACCE,
                    SelectSQLParser.MACROMAN,
                    SelectSQLParser.SJIS,
                    SelectSQLParser.SWE7,
                    SelectSQLParser.TIS620,
                    SelectSQLParser.UCS2,
                    SelectSQLParser.UJIS,
                    SelectSQLParser.UTF16,
                    SelectSQLParser.UTF16LE,
                    SelectSQLParser.UTF32,
                    SelectSQLParser.UTF8,
                    SelectSQLParser.UTF8MB3,
                    SelectSQLParser.UTF8MB4,
                    SelectSQLParser.ARCHIVE,
                    SelectSQLParser.BLACKHOLE,
                    SelectSQLParser.CSV,
                    SelectSQLParser.FEDERATED,
                    SelectSQLParser.INNODB,
                    SelectSQLParser.MEMORY,
                    SelectSQLParser.MRG_MYISAM,
                    SelectSQLParser.MYISAM,
                    SelectSQLParser.NDB,
                    SelectSQLParser.NDBCLUSTER,
                    SelectSQLParser.PERFOMANCE_SCHEMA,
                    SelectSQLParser.REPEATABLE,
                    SelectSQLParser.COMMITTED,
                    SelectSQLParser.UNCOMMITTED,
                    SelectSQLParser.SERIALIZABLE,
                    SelectSQLParser.GEOMETRYCOLLECTION,
                    SelectSQLParser.LINESTRING,
                    SelectSQLParser.MULTILINESTRING,
                    SelectSQLParser.MULTIPOINT,
                    SelectSQLParser.MULTIPOLYGON,
                    SelectSQLParser.POINT,
                    SelectSQLParser.POLYGON,
                    SelectSQLParser.ABS,
                    SelectSQLParser.ACOS,
                    SelectSQLParser.ADDDATE,
                    SelectSQLParser.ADDTIME,
                    SelectSQLParser.AES_DECRYPT,
                    SelectSQLParser.AES_ENCRYPT,
                    SelectSQLParser.AREA,
                    SelectSQLParser.ASBINARY,
                    SelectSQLParser.ASIN,
                    SelectSQLParser.ASTEXT,
                    SelectSQLParser.ASWKB,
                    SelectSQLParser.ASWKT,
                    SelectSQLParser.ASYMMETRIC_DECRYPT,
                    SelectSQLParser.ASYMMETRIC_DERIVE,
                    SelectSQLParser.ASYMMETRIC_ENCRYPT,
                    SelectSQLParser.ASYMMETRIC_SIGN,
                    SelectSQLParser.ASYMMETRIC_VERIFY,
                    SelectSQLParser.ATAN,
                    SelectSQLParser.ATAN2,
                    SelectSQLParser.BENCHMARK,
                    SelectSQLParser.BIN,
                    SelectSQLParser.BIT_COUNT,
                    SelectSQLParser.BIT_LENGTH,
                    SelectSQLParser.BUFFER,
                    SelectSQLParser.CEIL,
                    SelectSQLParser.CEILING,
                    SelectSQLParser.CENTROID,
                    SelectSQLParser.CHARACTER_LENGTH,
                    SelectSQLParser.CHARSET,
                    SelectSQLParser.CHAR_LENGTH,
                    SelectSQLParser.COERCIBILITY,
                    SelectSQLParser.COLLATION,
                    SelectSQLParser.COMPRESS,
                    SelectSQLParser.CONCAT,
                    SelectSQLParser.CONCAT_WS,
                    SelectSQLParser.CONNECTION_ID,
                    SelectSQLParser.CONV,
                    SelectSQLParser.CONVERT_TZ,
                    SelectSQLParser.COS,
                    SelectSQLParser.COT,
                    SelectSQLParser.CRC32,
                    SelectSQLParser.CREATE_ASYMMETRIC_PRIV_KEY,
                    SelectSQLParser.CREATE_ASYMMETRIC_PUB_KEY,
                    SelectSQLParser.CREATE_DH_PARAMETERS,
                    SelectSQLParser.CREATE_DIGEST,
                    SelectSQLParser.CROSSES,
                    SelectSQLParser.DATEDIFF,
                    SelectSQLParser.DATE_FORMAT,
                    SelectSQLParser.DAYNAME,
                    SelectSQLParser.DAYOFMONTH,
                    SelectSQLParser.DAYOFWEEK,
                    SelectSQLParser.DAYOFYEAR,
                    SelectSQLParser.DECODE,
                    SelectSQLParser.DEGREES,
                    SelectSQLParser.DES_DECRYPT,
                    SelectSQLParser.DES_ENCRYPT,
                    SelectSQLParser.DIMENSION,
                    SelectSQLParser.DISJOINT,
                    SelectSQLParser.ELT,
                    SelectSQLParser.ENCODE,
                    SelectSQLParser.ENCRYPT,
                    SelectSQLParser.ENDPOINT,
                    SelectSQLParser.ENVELOPE,
                    SelectSQLParser.EQUALS,
                    SelectSQLParser.EXP,
                    SelectSQLParser.EXPORT_SET,
                    SelectSQLParser.EXTERIORRING,
                    SelectSQLParser.EXTRACTVALUE,
                    SelectSQLParser.FIELD,
                    SelectSQLParser.FIND_IN_SET,
                    SelectSQLParser.FLOOR,
                    SelectSQLParser.FORMAT,
                    SelectSQLParser.FOUND_ROWS,
                    SelectSQLParser.FROM_BASE64,
                    SelectSQLParser.FROM_DAYS,
                    SelectSQLParser.FROM_UNIXTIME,
                    SelectSQLParser.GEOMCOLLFROMTEXT,
                    SelectSQLParser.GEOMCOLLFROMWKB,
                    SelectSQLParser.GEOMETRYCOLLECTIONFROMTEXT,
                    SelectSQLParser.GEOMETRYCOLLECTIONFROMWKB,
                    SelectSQLParser.GEOMETRYFROMTEXT,
                    SelectSQLParser.GEOMETRYFROMWKB,
                    SelectSQLParser.GEOMETRYN,
                    SelectSQLParser.GEOMETRYTYPE,
                    SelectSQLParser.GEOMFROMTEXT,
                    SelectSQLParser.GEOMFROMWKB,
                    SelectSQLParser.GET_FORMAT,
                    SelectSQLParser.GET_LOCK,
                    SelectSQLParser.GLENGTH,
                    SelectSQLParser.GREATEST,
                    SelectSQLParser.GTID_SUBSET,
                    SelectSQLParser.GTID_SUBTRACT,
                    SelectSQLParser.HEX,
                    SelectSQLParser.IFNULL,
                    SelectSQLParser.INET6_ATON,
                    SelectSQLParser.INET6_NTOA,
                    SelectSQLParser.INET_ATON,
                    SelectSQLParser.INET_NTOA,
                    SelectSQLParser.INSTR,
                    SelectSQLParser.INTERIORRINGN,
                    SelectSQLParser.INTERSECTS,
                    SelectSQLParser.ISCLOSED,
                    SelectSQLParser.ISEMPTY,
                    SelectSQLParser.ISNULL,
                    SelectSQLParser.ISSIMPLE,
                    SelectSQLParser.IS_FREE_LOCK,
                    SelectSQLParser.IS_IPV4,
                    SelectSQLParser.IS_IPV4_COMPAT,
                    SelectSQLParser.IS_IPV4_MAPPED,
                    SelectSQLParser.IS_IPV6,
                    SelectSQLParser.IS_USED_LOCK,
                    SelectSQLParser.LAST_INSERT_ID,
                    SelectSQLParser.LCASE,
                    SelectSQLParser.LEAST,
                    SelectSQLParser.LENGTH,
                    SelectSQLParser.LINEFROMTEXT,
                    SelectSQLParser.LINEFROMWKB,
                    SelectSQLParser.LINESTRINGFROMTEXT,
                    SelectSQLParser.LINESTRINGFROMWKB,
                    SelectSQLParser.LN,
                    SelectSQLParser.LOAD_FILE,
                    SelectSQLParser.LOCATE,
                    SelectSQLParser.LOG,
                    SelectSQLParser.LOG10,
                    SelectSQLParser.LOG2,
                    SelectSQLParser.LOWER,
                    SelectSQLParser.LPAD,
                    SelectSQLParser.LTRIM,
                    SelectSQLParser.MAKEDATE,
                    SelectSQLParser.MAKETIME,
                    SelectSQLParser.MAKE_SET,
                    SelectSQLParser.MASTER_POS_WAIT,
                    SelectSQLParser.MBRCONTAINS,
                    SelectSQLParser.MBRDISJOINT,
                    SelectSQLParser.MBREQUAL,
                    SelectSQLParser.MBRINTERSECTS,
                    SelectSQLParser.MBROVERLAPS,
                    SelectSQLParser.MBRTOUCHES,
                    SelectSQLParser.MBRWITHIN,
                    SelectSQLParser.MD5,
                    SelectSQLParser.MLINEFROMTEXT,
                    SelectSQLParser.MLINEFROMWKB,
                    SelectSQLParser.MONTHNAME,
                    SelectSQLParser.MPOINTFROMTEXT,
                    SelectSQLParser.MPOINTFROMWKB,
                    SelectSQLParser.MPOLYFROMTEXT,
                    SelectSQLParser.MPOLYFROMWKB,
                    SelectSQLParser.MULTILINESTRINGFROMTEXT,
                    SelectSQLParser.MULTILINESTRINGFROMWKB,
                    SelectSQLParser.MULTIPOINTFROMTEXT,
                    SelectSQLParser.MULTIPOINTFROMWKB,
                    SelectSQLParser.MULTIPOLYGONFROMTEXT,
                    SelectSQLParser.MULTIPOLYGONFROMWKB,
                    SelectSQLParser.NAME_CONST,
                    SelectSQLParser.NULLIF,
                    SelectSQLParser.NUMGEOMETRIES,
                    SelectSQLParser.NUMINTERIORRINGS,
                    SelectSQLParser.NUMPOINTS,
                    SelectSQLParser.OCT,
                    SelectSQLParser.OCTET_LENGTH,
                    SelectSQLParser.ORD,
                    SelectSQLParser.OVERLAPS,
                    SelectSQLParser.PERIOD_ADD,
                    SelectSQLParser.PERIOD_DIFF,
                    SelectSQLParser.PI,
                    SelectSQLParser.POINTFROMTEXT,
                    SelectSQLParser.POINTFROMWKB,
                    SelectSQLParser.POINTN,
                    SelectSQLParser.POLYFROMTEXT,
                    SelectSQLParser.POLYFROMWKB,
                    SelectSQLParser.POLYGONFROMTEXT,
                    SelectSQLParser.POLYGONFROMWKB,
                    SelectSQLParser.POW,
                    SelectSQLParser.POWER,
                    SelectSQLParser.QUOTE,
                    SelectSQLParser.RADIANS,
                    SelectSQLParser.RAND,
                    SelectSQLParser.RANDOM_BYTES,
                    SelectSQLParser.RELEASE_LOCK,
                    SelectSQLParser.REVERSE,
                    SelectSQLParser.ROUND,
                    SelectSQLParser.ROW_COUNT,
                    SelectSQLParser.RPAD,
                    SelectSQLParser.RTRIM,
                    SelectSQLParser.SEC_TO_TIME,
                    SelectSQLParser.SESSION_USER,
                    SelectSQLParser.SHA,
                    SelectSQLParser.SHA1,
                    SelectSQLParser.SHA2,
                    SelectSQLParser.SIGN,
                    SelectSQLParser.SIN,
                    SelectSQLParser.SLEEP,
                    SelectSQLParser.SOUNDEX,
                    SelectSQLParser.SQL_THREAD_WAIT_AFTER_GTIDS,
                    SelectSQLParser.SQRT,
                    SelectSQLParser.SRID,
                    SelectSQLParser.STARTPOINT,
                    SelectSQLParser.STRCMP,
                    SelectSQLParser.STR_TO_DATE,
                    SelectSQLParser.ST_AREA,
                    SelectSQLParser.ST_ASBINARY,
                    SelectSQLParser.ST_ASTEXT,
                    SelectSQLParser.ST_ASWKB,
                    SelectSQLParser.ST_ASWKT,
                    SelectSQLParser.ST_BUFFER,
                    SelectSQLParser.ST_CENTROID,
                    SelectSQLParser.ST_CONTAINS,
                    SelectSQLParser.ST_CROSSES,
                    SelectSQLParser.ST_DIFFERENCE,
                    SelectSQLParser.ST_DIMENSION,
                    SelectSQLParser.ST_DISJOINT,
                    SelectSQLParser.ST_DISTANCE,
                    SelectSQLParser.ST_ENDPOINT,
                    SelectSQLParser.ST_ENVELOPE,
                    SelectSQLParser.ST_EQUALS,
                    SelectSQLParser.ST_EXTERIORRING,
                    SelectSQLParser.ST_GEOMCOLLFROMTEXT,
                    SelectSQLParser.ST_GEOMCOLLFROMTXT,
                    SelectSQLParser.ST_GEOMCOLLFROMWKB,
                    SelectSQLParser.ST_GEOMETRYCOLLECTIONFROMTEXT,
                    SelectSQLParser.ST_GEOMETRYCOLLECTIONFROMWKB,
                    SelectSQLParser.ST_GEOMETRYFROMTEXT,
                    SelectSQLParser.ST_GEOMETRYFROMWKB,
                    SelectSQLParser.ST_GEOMETRYN,
                    SelectSQLParser.ST_GEOMETRYTYPE,
                    SelectSQLParser.ST_GEOMFROMTEXT,
                    SelectSQLParser.ST_GEOMFROMWKB,
                    SelectSQLParser.ST_INTERIORRINGN,
                    SelectSQLParser.ST_INTERSECTION,
                    SelectSQLParser.ST_INTERSECTS,
                    SelectSQLParser.ST_ISCLOSED,
                    SelectSQLParser.ST_ISEMPTY,
                    SelectSQLParser.ST_ISSIMPLE,
                    SelectSQLParser.ST_LINEFROMTEXT,
                    SelectSQLParser.ST_LINEFROMWKB,
                    SelectSQLParser.ST_LINESTRINGFROMTEXT,
                    SelectSQLParser.ST_LINESTRINGFROMWKB,
                    SelectSQLParser.ST_NUMGEOMETRIES,
                    SelectSQLParser.ST_NUMINTERIORRING,
                    SelectSQLParser.ST_NUMINTERIORRINGS,
                    SelectSQLParser.ST_NUMPOINTS,
                    SelectSQLParser.ST_OVERLAPS,
                    SelectSQLParser.ST_POINTFROMTEXT,
                    SelectSQLParser.ST_POINTFROMWKB,
                    SelectSQLParser.ST_POINTN,
                    SelectSQLParser.ST_POLYFROMTEXT,
                    SelectSQLParser.ST_POLYFROMWKB,
                    SelectSQLParser.ST_POLYGONFROMTEXT,
                    SelectSQLParser.ST_POLYGONFROMWKB,
                    SelectSQLParser.ST_SRID,
                    SelectSQLParser.ST_STARTPOINT,
                    SelectSQLParser.ST_SYMDIFFERENCE,
                    SelectSQLParser.ST_TOUCHES,
                    SelectSQLParser.ST_UNION,
                    SelectSQLParser.ST_WITHIN,
                    SelectSQLParser.ST_X,
                    SelectSQLParser.ST_Y,
                    SelectSQLParser.SUBDATE,
                    SelectSQLParser.SUBSTRING_INDEX,
                    SelectSQLParser.SUBTIME,
                    SelectSQLParser.SYSTEM_USER,
                    SelectSQLParser.TAN,
                    SelectSQLParser.TIMEDIFF,
                    SelectSQLParser.TIMESTAMPADD,
                    SelectSQLParser.TIMESTAMPDIFF,
                    SelectSQLParser.TIME_FORMAT,
                    SelectSQLParser.TIME_TO_SEC,
                    SelectSQLParser.TOUCHES,
                    SelectSQLParser.TO_BASE64,
                    SelectSQLParser.TO_DAYS,
                    SelectSQLParser.TO_SECONDS,
                    SelectSQLParser.UCASE,
                    SelectSQLParser.UNCOMPRESS,
                    SelectSQLParser.UNCOMPRESSED_LENGTH,
                    SelectSQLParser.UNHEX,
                    SelectSQLParser.UNIX_TIMESTAMP,
                    SelectSQLParser.UPDATEXML,
                    SelectSQLParser.UPPER,
                    SelectSQLParser.UUID,
                    SelectSQLParser.UUID_SHORT,
                    SelectSQLParser.VALIDATE_PASSWORD_STRENGTH,
                    SelectSQLParser.VERSION,
                    SelectSQLParser.WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS,
                    SelectSQLParser.WEEKDAY,
                    SelectSQLParser.WEEKOFYEAR,
                    SelectSQLParser.WEIGHT_STRING,
                    SelectSQLParser.WITHIN,
                    SelectSQLParser.YEARWEEK,
                    SelectSQLParser.Y_FUNCTION,
                    SelectSQLParser.X_FUNCTION,
                    SelectSQLParser.RR_BRACKET,
                    SelectSQLParser.COMMA,
                    SelectSQLParser.SEMI,
                    SelectSQLParser.CHARSET_REVERSE_QOUTE_STRING,
                    SelectSQLParser.ID,
                    SelectSQLParser.REVERSE_QUOTE_ID,
                ]:
                    pass
                else:
                    pass
                ...
                if _la == SelectSQLParser.LEFT or _la == SelectSQLParser.RIGHT:
                    ...
                    _la = self._input.LA(1)
                    if not (
                        _la == SelectSQLParser.LEFT or _la == SelectSQLParser.RIGHT
                    ):
                        self._errHandler.recoverInline(self)
                    else:
                        self._errHandler.reportMatch(self)
    ...
    def querySpecification(self):
        ...
        localctx = SelectSQLParser.QuerySpecificationContext(
    ...
    def selectElements(self):
        ...
        try:
            ...
            if token in [SelectSQLParser.STAR]:
                ...
                SelectSQLParser.CASE,
                SelectSQLParser.CAST,
                SelectSQLParser.CONVERT,
                SelectSQLParser.CURRENT_USER,
                SelectSQLParser.EXISTS,
                SelectSQLParser.FALSE,
                SelectSQLParser.IF,
                SelectSQLParser.INSERT,
                SelectSQLParser.INTERVAL,
                SelectSQLParser.LEFT,
                SelectSQLParser.NOT,
                SelectSQLParser.NULL_LITERAL,
                SelectSQLParser.REPLACE,
                SelectSQLParser.RIGHT,
                SelectSQLParser.TRUE,
                SelectSQLParser.VALUES,
                SelectSQLParser.DATE,
                SelectSQLParser.TIME,
                SelectSQLParser.TIMESTAMP,
                SelectSQLParser.DATETIME,
                SelectSQLParser.YEAR,
                SelectSQLParser.CHAR,
                SelectSQLParser.BINARY,
                SelectSQLParser.TEXT,
                SelectSQLParser.ENUM,
                SelectSQLParser.AVG,
                SelectSQLParser.BIT_AND,
                SelectSQLParser.BIT_OR,
                SelectSQLParser.BIT_XOR,
                SelectSQLParser.COUNT,
                SelectSQLParser.GROUP_CONCAT,
                SelectSQLParser.MAX,
                SelectSQLParser.MIN,
                SelectSQLParser.STD,
                SelectSQLParser.STDDEV,
                SelectSQLParser.STDDEV_POP,
                SelectSQLParser.STDDEV_SAMP,
                SelectSQLParser.SUM,
                SelectSQLParser.VAR_POP,
                SelectSQLParser.VAR_SAMP,
                SelectSQLParser.VARIANCE,
                SelectSQLParser.CURRENT_DATE,
                SelectSQLParser.CURRENT_TIME,
                SelectSQLParser.CURRENT_TIMESTAMP,
                SelectSQLParser.LOCALTIME,
                SelectSQLParser.CURDATE,
                SelectSQLParser.CURTIME,
                SelectSQLParser.DATE_ADD,
                SelectSQLParser.DATE_SUB,
                SelectSQLParser.EXTRACT,
                SelectSQLParser.LOCALTIMESTAMP,
                SelectSQLParser.NOW,
                SelectSQLParser.POSITION,
                SelectSQLParser.SUBSTR,
                SelectSQLParser.SUBSTRING,
                SelectSQLParser.SYSDATE,
                SelectSQLParser.TRIM,
                SelectSQLParser.UTC_DATE,
                SelectSQLParser.UTC_TIME,
                SelectSQLParser.UTC_TIMESTAMP,
                SelectSQLParser.ACCOUNT,
                SelectSQLParser.ACTION,
                SelectSQLParser.AFTER,
                SelectSQLParser.AGGREGATE,
                ...
                SelectSQLParser.Y_FUNCTION,
                SelectSQLParser.X_FUNCTION,
                SelectSQLParser.PLUS,
                SelectSQLParser.MINUS,
                SelectSQLParser.EXCLAMATION_SYMBOL,
                SelectSQLParser.BIT_NOT_OP,
                SelectSQLParser.LR_BRACKET,
                SelectSQLParser.ZERO_DECIMAL,
                SelectSQLParser.ONE_DECIMAL,
                SelectSQLParser.TWO_DECIMAL,
                SelectSQLParser.CHARSET_REVERSE_QOUTE_STRING,
                SelectSQLParser.START_NATIONAL_STRING_LITERAL,
                SelectSQLParser.STRING_LITERAL,
                SelectSQLParser.DECIMAL_LITERAL,
                SelectSQLParser.HEXADECIMAL_LITERAL,
                SelectSQLParser.REAL_LITERAL,
                SelectSQLParser.NULL_SPEC_LITERAL,
                SelectSQLParser.BIT_STRING,
                SelectSQLParser.STRING_CHARSET_NAME,
                SelectSQLParser.ID,
                SelectSQLParser.REVERSE_QUOTE_ID,
                SelectSQLParser.LOCAL_ID,
                SelectSQLParser.GLOBAL_ID,
            ]:
                self.state = 398
                self.selectElement()
                pass
    ...
    class SelectExpressionElementContext(SelectElementContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.SelectElementContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    def selectElement(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = SelectSQLParser.SelectExpressionElementContext(
                    self, localctx
                )
                self.enterOuterAlt(localctx, 4)
                self.state = 428
    ...
    class LimitClauseContext(ParserRuleContext):
        ...
        def decimalLiteral(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.DecimalLiteralContext, i
                )
    ...
    def userName(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.ID or _la == SelectSQLParser.STRING_USER_NAME
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
    ...
    def variable(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.LOCAL_ID or _la == SelectSQLParser.GLOBAL_ID
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 607))
                        & (
                            (1 << (SelectSQLParser.ARCHIVE - 607))
                            | (1 << (SelectSQLParser.BLACKHOLE - 607))
                            | (1 << (SelectSQLParser.CSV - 607))
                            | (1 << (SelectSQLParser.FEDERATED - 607))
                            | (1 << (SelectSQLParser.INNODB - 607))
                            | (1 << (SelectSQLParser.MEMORY - 607))
                            | (1 << (SelectSQLParser.MRG_MYISAM - 607))
                            | (1 << (SelectSQLParser.MYISAM - 607))
                            | (1 << (SelectSQLParser.NDB - 607))
                            | (1 << (SelectSQLParser.NDBCLUSTER - 607))
                            | (1 << (SelectSQLParser.PERFOMANCE_SCHEMA - 607))
                        )
                    )
                    != 0
                )
    ...
    class SimpleIdContext(ParserRuleContext):
        ...
        def transactionLevelBase(self):
            return self.getTypedRuleContext(
                SelectSQLParser.TransactionLevelBaseContext, 0
            )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 950))
                        & (
                            (1 << (SelectSQLParser.ZERO_DECIMAL - 950))
                            | (1 << (SelectSQLParser.ONE_DECIMAL - 950))
                            | (1 << (SelectSQLParser.TWO_DECIMAL - 950))
                            | (1 << (SelectSQLParser.DECIMAL_LITERAL - 950))
                        )
                    )
                    != 0
                )
    ...
    def hexadecimalLiteral(self):
        ...
        localctx = SelectSQLParser.HexadecimalLiteralContext(
            self, self._ctx, self.state
        )
    ...
    def nullNotnull(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.NULL_LITERAL
                or _la == SelectSQLParser.NULL_SPEC_LITERAL
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
    ...
    class ConstantContext(ParserRuleContext):
        ...
        def hexadecimalLiteral(self):
            return self.getTypedRuleContext(
                SelectSQLParser.HexadecimalLiteralContext, 0
            )
    ...
    class SpatialDataTypeContext(DataTypeContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.DataTypeContext
            super().__init__(parser)
    ...
    class DimensionDataTypeContext(DataTypeContext):
        ...
        def lengthOneDimension(self):
            return self.getTypedRuleContext(
                SelectSQLParser.LengthOneDimensionContext, 0
            )
        ...
        def lengthTwoDimension(self):
            return self.getTypedRuleContext(
                SelectSQLParser.LengthTwoDimensionContext, 0
            )
        ...
        def lengthTwoOptionalDimension(self):
            return self.getTypedRuleContext(
                SelectSQLParser.LengthTwoOptionalDimensionContext, 0
            )
    ...
    def dataType(self):
        ...
        try:
            ...
            if token in [
                SelectSQLParser.CHAR,
                SelectSQLParser.VARCHAR,
                SelectSQLParser.TINYTEXT,
                SelectSQLParser.TEXT,
                SelectSQLParser.MEDIUMTEXT,
                SelectSQLParser.LONGTEXT,
            ]:
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 185))
                            & (
                                (1 << (SelectSQLParser.CHAR - 185))
                                | (1 << (SelectSQLParser.VARCHAR - 185))
                                | (1 << (SelectSQLParser.TINYTEXT - 185))
                                | (1 << (SelectSQLParser.TEXT - 185))
                                | (1 << (SelectSQLParser.MEDIUMTEXT - 185))
                                | (1 << (SelectSQLParser.LONGTEXT - 185))
                            )
                        )
                        != 0
                    )
                ...
                SelectSQLParser.TINYINT,
                SelectSQLParser.SMALLINT,
                SelectSQLParser.MEDIUMINT,
                SelectSQLParser.INT,
                SelectSQLParser.INTEGER,
                SelectSQLParser.BIGINT,
            ]:
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 169))
                            & (
                                (1 << (SelectSQLParser.TINYINT - 169))
                                | (1 << (SelectSQLParser.SMALLINT - 169))
                                | (1 << (SelectSQLParser.MEDIUMINT - 169))
                                | (1 << (SelectSQLParser.INT - 169))
                                | (1 << (SelectSQLParser.INTEGER - 169))
                                | (1 << (SelectSQLParser.BIGINT - 169))
                            )
                        )
                        != 0
                    )
                ...
                SelectSQLParser.REAL,
                SelectSQLParser.DOUBLE,
                SelectSQLParser.FLOAT,
            ]:
                localctx = SelectSQLParser.DimensionDataTypeContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 680
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 175))
                            & (
                                (1 << (SelectSQLParser.REAL - 175))
                                | (1 << (SelectSQLParser.DOUBLE - 175))
                                | (1 << (SelectSQLParser.FLOAT - 175))
                            )
                        )
                        != 0
                    )
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.DECIMAL or _la == SelectSQLParser.NUMERIC
                ):
                    localctx.typeName = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                ...
                SelectSQLParser.DATE,
                SelectSQLParser.TINYBLOB,
                SelectSQLParser.BLOB,
                SelectSQLParser.MEDIUMBLOB,
                SelectSQLParser.LONGBLOB,
                SelectSQLParser.BOOL,
                SelectSQLParser.BOOLEAN,
            ]:
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 180))
                            & (
                                (1 << (SelectSQLParser.DATE - 180))
                                | (1 << (SelectSQLParser.TINYBLOB - 180))
                                | (1 << (SelectSQLParser.BLOB - 180))
                                | (1 << (SelectSQLParser.MEDIUMBLOB - 180))
                                | (1 << (SelectSQLParser.LONGBLOB - 180))
                            )
                        )
                        != 0
                    )
                    or _la == SelectSQLParser.BOOL
                    or _la == SelectSQLParser.BOOLEAN
                ):
                    localctx.typeName = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 181))
                            & (
                                (1 << (SelectSQLParser.TIME - 181))
                                | (1 << (SelectSQLParser.TIMESTAMP - 181))
                                | (1 << (SelectSQLParser.DATETIME - 181))
                                | (1 << (SelectSQLParser.YEAR - 181))
                                | (1 << (SelectSQLParser.BINARY - 181))
                                | (1 << (SelectSQLParser.VARBINARY - 181))
                            )
                        )
                        != 0
                    )
                    or _la == SelectSQLParser.BIT
                ):
                    localctx.typeName = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 622))
                            & (
                                (1 << (SelectSQLParser.GEOMETRYCOLLECTION - 622))
                                | (1 << (SelectSQLParser.LINESTRING - 622))
                                | (1 << (SelectSQLParser.MULTILINESTRING - 622))
                                | (1 << (SelectSQLParser.MULTIPOINT - 622))
                                | (1 << (SelectSQLParser.MULTIPOLYGON - 622))
                                | (1 << (SelectSQLParser.POINT - 622))
                                | (1 << (SelectSQLParser.POLYGON - 622))
                            )
                        )
                        != 0
                    )
    ...
    def convertedDataType(self):
        ...
        try:
            ...
            if token in [SelectSQLParser.BINARY, SelectSQLParser.NCHAR]:
                ...
                if not (
                    (
                        ...
                        and (
                            ...
                            & (
                                (1 << (SelectSQLParser.DATE - 180))
                                | (1 << (SelectSQLParser.TIME - 180))
                                | (1 << (SelectSQLParser.DATETIME - 180))
                            )
                        )
                        != 0
                    )
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.UNSIGNED or _la == SelectSQLParser.SIGNED
                ):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
    ...
    def lengthOneDimension(self):
        ...
        localctx = SelectSQLParser.LengthOneDimensionContext(
            self, self._ctx, self.state
        )
    ...
    def lengthTwoDimension(self):
        ...
        localctx = SelectSQLParser.LengthTwoDimensionContext(
            self, self._ctx, self.state
        )
    ...
    def lengthTwoOptionalDimension(self):
        ...
        localctx = SelectSQLParser.LengthTwoOptionalDimensionContext(
            self, self._ctx, self.state
        )
    ...
    class IndexColumnNamesContext(ParserRuleContext):
        ...
        def indexColumnName(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.IndexColumnNameContext, i
                )
    ...
    class ExpressionsWithDefaultsContext(ParserRuleContext):
        ...
        def expressionOrDefault(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.ExpressionOrDefaultContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.ExpressionOrDefaultContext, i
                )
    ...
    def expressionsWithDefaults(self):
        ...
        localctx = SelectSQLParser.ExpressionsWithDefaultsContext(
            self, self._ctx, self.state
        )
    ...
    class DefaultValueContext(ParserRuleContext):
        ...
        def currentTimestamp(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.CurrentTimestampContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.CurrentTimestampContext, i
                )
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 227))
                            & (
                                (1 << (SelectSQLParser.CURRENT_TIMESTAMP - 227))
                                | (1 << (SelectSQLParser.LOCALTIME - 227))
                                | (1 << (SelectSQLParser.LOCALTIMESTAMP - 227))
                            )
                        )
                        != 0
                    )
    ...
    def expressionOrDefault(self):
        ...
        localctx = SelectSQLParser.ExpressionOrDefaultContext(
            self, self._ctx, self.state
        )
    ...
    class SpecificFunctionCallContext(FunctionCallContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.FunctionCallContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class PasswordFunctionCallContext(FunctionCallContext):
        ...
        def passwordFunctionClause(self):
            return self.getTypedRuleContext(
                SelectSQLParser.PasswordFunctionClauseContext, 0
            )
    ...
    class AggregateFunctionCallContext(FunctionCallContext):
        ...
        def aggregateWindowedFunction(self):
            return self.getTypedRuleContext(
                SelectSQLParser.AggregateWindowedFunctionContext, 0
            )
    ...
    class ScalarFunctionCallContext(FunctionCallContext):
        ...
        def scalarFunctionName(self):
            return self.getTypedRuleContext(
                SelectSQLParser.ScalarFunctionNameContext, 0
            )
                ...
                if (
                    (
                        ...
                        and (
                            (1 << _la)
                            & (
                                (1 << SelectSQLParser.CASE)
                                | (1 << SelectSQLParser.CAST)
                                | (1 << SelectSQLParser.CONVERT)
                                | (1 << SelectSQLParser.CURRENT_USER)
                                | (1 << SelectSQLParser.EXISTS)
                                | (1 << SelectSQLParser.FALSE)
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 64))
                            & (
                                (1 << (SelectSQLParser.IF - 64))
                                | (1 << (SelectSQLParser.INSERT - 64))
                                | (1 << (SelectSQLParser.INTERVAL - 64))
                                | (1 << (SelectSQLParser.LEFT - 64))
                                | (1 << (SelectSQLParser.NOT - 64))
                                | (1 << (SelectSQLParser.NULL_LITERAL - 64))
                                | (1 << (SelectSQLParser.REPLACE - 64))
                                | (1 << (SelectSQLParser.RIGHT - 64))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 151))
                            & (
                                (1 << (SelectSQLParser.TRUE - 151))
                                | (1 << (SelectSQLParser.VALUES - 151))
                                | (1 << (SelectSQLParser.DATE - 151))
                                | (1 << (SelectSQLParser.TIME - 151))
                                | (1 << (SelectSQLParser.TIMESTAMP - 151))
                                | (1 << (SelectSQLParser.DATETIME - 151))
                                | (1 << (SelectSQLParser.YEAR - 151))
                                | (1 << (SelectSQLParser.CHAR - 151))
                                | (1 << (SelectSQLParser.BINARY - 151))
                                | (1 << (SelectSQLParser.TEXT - 151))
                                | (1 << (SelectSQLParser.ENUM - 151))
                                | (1 << (SelectSQLParser.AVG - 151))
                                | (1 << (SelectSQLParser.BIT_AND - 151))
                                | (1 << (SelectSQLParser.BIT_OR - 151))
                                | (1 << (SelectSQLParser.BIT_XOR - 151))
                                | (1 << (SelectSQLParser.COUNT - 151))
                                | (1 << (SelectSQLParser.GROUP_CONCAT - 151))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 215))
                            & (
                                (1 << (SelectSQLParser.MAX - 215))
                                | (1 << (SelectSQLParser.MIN - 215))
                                | (1 << (SelectSQLParser.STD - 215))
                                | (1 << (SelectSQLParser.STDDEV - 215))
                                | (1 << (SelectSQLParser.STDDEV_POP - 215))
                                | (1 << (SelectSQLParser.STDDEV_SAMP - 215))
                                | (1 << (SelectSQLParser.SUM - 215))
                                | (1 << (SelectSQLParser.VAR_POP - 215))
                                | (1 << (SelectSQLParser.VAR_SAMP - 215))
                                | (1 << (SelectSQLParser.VARIANCE - 215))
                                | (1 << (SelectSQLParser.CURRENT_DATE - 215))
                                | (1 << (SelectSQLParser.CURRENT_TIME - 215))
                                | (1 << (SelectSQLParser.CURRENT_TIMESTAMP - 215))
                                | (1 << (SelectSQLParser.LOCALTIME - 215))
                                | (1 << (SelectSQLParser.CURDATE - 215))
                                | (1 << (SelectSQLParser.CURTIME - 215))
                                | (1 << (SelectSQLParser.DATE_ADD - 215))
                                | (1 << (SelectSQLParser.DATE_SUB - 215))
                                | (1 << (SelectSQLParser.EXTRACT - 215))
                                | (1 << (SelectSQLParser.LOCALTIMESTAMP - 215))
                                | (1 << (SelectSQLParser.NOW - 215))
                                | (1 << (SelectSQLParser.POSITION - 215))
                                | (1 << (SelectSQLParser.SUBSTR - 215))
                                | (1 << (SelectSQLParser.SUBSTRING - 215))
                                | (1 << (SelectSQLParser.SYSDATE - 215))
                                | (1 << (SelectSQLParser.TRIM - 215))
                                | (1 << (SelectSQLParser.UTC_DATE - 215))
                                | (1 << (SelectSQLParser.UTC_TIME - 215))
                                | (1 << (SelectSQLParser.UTC_TIMESTAMP - 215))
                                | (1 << (SelectSQLParser.ACCOUNT - 215))
                                | (1 << (SelectSQLParser.ACTION - 215))
                                | (1 << (SelectSQLParser.AFTER - 215))
                                | (1 << (SelectSQLParser.AGGREGATE - 215))
                                | (1 << (SelectSQLParser.ALGORITHM - 215))
                                | (1 << (SelectSQLParser.ANY - 215))
                                | (1 << (SelectSQLParser.AT - 215))
                                | (1 << (SelectSQLParser.AUTHORS - 215))
                                | (1 << (SelectSQLParser.AUTOCOMMIT - 215))
                                | (1 << (SelectSQLParser.AUTOEXTEND_SIZE - 215))
                                | (1 << (SelectSQLParser.AUTO_INCREMENT - 215))
                                | (1 << (SelectSQLParser.AVG_ROW_LENGTH - 215))
                                | (1 << (SelectSQLParser.BEGIN - 215))
                                | (1 << (SelectSQLParser.BINLOG - 215))
                                | (1 << (SelectSQLParser.BIT - 215))
                                | (1 << (SelectSQLParser.BLOCK - 215))
                                | (1 << (SelectSQLParser.BOOL - 215))
                                | (1 << (SelectSQLParser.BOOLEAN - 215))
                                | (1 << (SelectSQLParser.BTREE - 215))
                                | (1 << (SelectSQLParser.CASCADED - 215))
                                | (1 << (SelectSQLParser.CHAIN - 215))
                                | (1 << (SelectSQLParser.CHANNEL - 215))
                                | (1 << (SelectSQLParser.CHECKSUM - 215))
                                | (1 << (SelectSQLParser.CIPHER - 215))
                                | (1 << (SelectSQLParser.CLIENT - 215))
                                | (1 << (SelectSQLParser.COALESCE - 215))
                                | (1 << (SelectSQLParser.CODE - 215))
                                | (1 << (SelectSQLParser.COLUMNS - 215))
                                | (1 << (SelectSQLParser.COLUMN_FORMAT - 215))
                                | (1 << (SelectSQLParser.COMMENT - 215))
                                | (1 << (SelectSQLParser.COMMIT - 215))
                                | (1 << (SelectSQLParser.COMPACT - 215))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 279))
                            & (
                                (1 << (SelectSQLParser.COMPLETION - 279))
                                | (1 << (SelectSQLParser.COMPRESSED - 279))
                                | (1 << (SelectSQLParser.COMPRESSION - 279))
                                | (1 << (SelectSQLParser.CONCURRENT - 279))
                                | (1 << (SelectSQLParser.CONNECTION - 279))
                                | (1 << (SelectSQLParser.CONSISTENT - 279))
                                | (1 << (SelectSQLParser.CONTAINS - 279))
                                | (1 << (SelectSQLParser.CONTEXT - 279))
                                | (1 << (SelectSQLParser.CONTRIBUTORS - 279))
                                | (1 << (SelectSQLParser.COPY - 279))
                                | (1 << (SelectSQLParser.CPU - 279))
                                | (1 << (SelectSQLParser.DATA - 279))
                                | (1 << (SelectSQLParser.DATAFILE - 279))
                                | (1 << (SelectSQLParser.DEALLOCATE - 279))
                                | (1 << (SelectSQLParser.DEFAULT_AUTH - 279))
                                | (1 << (SelectSQLParser.DEFINER - 279))
                                | (1 << (SelectSQLParser.DELAY_KEY_WRITE - 279))
                                | (1 << (SelectSQLParser.DIRECTORY - 279))
                                | (1 << (SelectSQLParser.DISABLE - 279))
                                | (1 << (SelectSQLParser.DISCARD - 279))
                                | (1 << (SelectSQLParser.DISK - 279))
                                | (1 << (SelectSQLParser.DO - 279))
                                | (1 << (SelectSQLParser.DUMPFILE - 279))
                                | (1 << (SelectSQLParser.DUPLICATE - 279))
                                | (1 << (SelectSQLParser.DYNAMIC - 279))
                                | (1 << (SelectSQLParser.ENABLE - 279))
                                | (1 << (SelectSQLParser.ENCRYPTION - 279))
                                | (1 << (SelectSQLParser.ENDS - 279))
                                | (1 << (SelectSQLParser.ENGINE - 279))
                                | (1 << (SelectSQLParser.ENGINES - 279))
                                | (1 << (SelectSQLParser.ERROR - 279))
                                | (1 << (SelectSQLParser.ERRORS - 279))
                                | (1 << (SelectSQLParser.ESCAPE - 279))
                                | (1 << (SelectSQLParser.EVEN - 279))
                                | (1 << (SelectSQLParser.EVENT - 279))
                                | (1 << (SelectSQLParser.EVENTS - 279))
                                | (1 << (SelectSQLParser.EVERY - 279))
                                | (1 << (SelectSQLParser.EXCHANGE - 279))
                                | (1 << (SelectSQLParser.EXCLUSIVE - 279))
                                | (1 << (SelectSQLParser.EXPIRE - 279))
                                | (1 << (SelectSQLParser.EXTENT_SIZE - 279))
                                | (1 << (SelectSQLParser.FAULTS - 279))
                                | (1 << (SelectSQLParser.FIELDS - 279))
                                | (1 << (SelectSQLParser.FILE_BLOCK_SIZE - 279))
                                | (1 << (SelectSQLParser.FILTER - 279))
                                | (1 << (SelectSQLParser.FIRST - 279))
                                | (1 << (SelectSQLParser.FIXED - 279))
                                | (1 << (SelectSQLParser.FOLLOWS - 279))
                                | (1 << (SelectSQLParser.FULL - 279))
                                | (1 << (SelectSQLParser.FUNCTION - 279))
                                | (1 << (SelectSQLParser.GLOBAL - 279))
                                | (1 << (SelectSQLParser.GRANTS - 279))
                                | (1 << (SelectSQLParser.GROUP_REPLICATION - 279))
                                | (1 << (SelectSQLParser.HASH - 279))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 343))
                            & (
                                (1 << (SelectSQLParser.HOST - 343))
                                | (1 << (SelectSQLParser.IDENTIFIED - 343))
                                | (1 << (SelectSQLParser.IGNORE_SERVER_IDS - 343))
                                | (1 << (SelectSQLParser.IMPORT - 343))
                                | (1 << (SelectSQLParser.INDEXES - 343))
                                | (1 << (SelectSQLParser.INITIAL_SIZE - 343))
                                | (1 << (SelectSQLParser.INPLACE - 343))
                                | (1 << (SelectSQLParser.INSERT_METHOD - 343))
                                | (1 << (SelectSQLParser.INSTANCE - 343))
                                | (1 << (SelectSQLParser.INVOKER - 343))
                                | (1 << (SelectSQLParser.IO - 343))
                                | (1 << (SelectSQLParser.IO_THREAD - 343))
                                | (1 << (SelectSQLParser.IPC - 343))
                                | (1 << (SelectSQLParser.ISOLATION - 343))
                                | (1 << (SelectSQLParser.ISSUER - 343))
                                | (1 << (SelectSQLParser.KEY_BLOCK_SIZE - 343))
                                | (1 << (SelectSQLParser.LANGUAGE - 343))
                                | (1 << (SelectSQLParser.LAST - 343))
                                | (1 << (SelectSQLParser.LEAVES - 343))
                                | (1 << (SelectSQLParser.LESS - 343))
                                | (1 << (SelectSQLParser.LEVEL - 343))
                                | (1 << (SelectSQLParser.LIST - 343))
                                | (1 << (SelectSQLParser.LOCAL - 343))
                                | (1 << (SelectSQLParser.LOGFILE - 343))
                                | (1 << (SelectSQLParser.LOGS - 343))
                                | (1 << (SelectSQLParser.MASTER - 343))
                                | (1 << (SelectSQLParser.MASTER_AUTO_POSITION - 343))
                                | (1 << (SelectSQLParser.MASTER_CONNECT_RETRY - 343))
                                | (1 << (SelectSQLParser.MASTER_DELAY - 343))
                                | (1 << (SelectSQLParser.MASTER_HEARTBEAT_PERIOD - 343))
                                | (1 << (SelectSQLParser.MASTER_HOST - 343))
                                | (1 << (SelectSQLParser.MASTER_LOG_FILE - 343))
                                | (1 << (SelectSQLParser.MASTER_LOG_POS - 343))
                                | (1 << (SelectSQLParser.MASTER_PASSWORD - 343))
                                | (1 << (SelectSQLParser.MASTER_PORT - 343))
                                | (1 << (SelectSQLParser.MASTER_RETRY_COUNT - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CA - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CAPATH - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CERT - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CIPHER - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CRL - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_CRLPATH - 343))
                                | (1 << (SelectSQLParser.MASTER_SSL_KEY - 343))
                                | (1 << (SelectSQLParser.MASTER_TLS_VERSION - 343))
                                | (1 << (SelectSQLParser.MASTER_USER - 343))
                                | (
                                    1
                                    << (SelectSQLParser.MAX_CONNECTIONS_PER_HOUR - 343)
                                )
                                | (1 << (SelectSQLParser.MAX_QUERIES_PER_HOUR - 343))
                                | (1 << (SelectSQLParser.MAX_ROWS - 343))
                                | (1 << (SelectSQLParser.MAX_SIZE - 343))
                                | (1 << (SelectSQLParser.MAX_UPDATES_PER_HOUR - 343))
                                | (1 << (SelectSQLParser.MAX_USER_CONNECTIONS - 343))
                                | (1 << (SelectSQLParser.MERGE - 343))
                                | (1 << (SelectSQLParser.MID - 343))
                                | (1 << (SelectSQLParser.MIGRATE - 343))
                                | (1 << (SelectSQLParser.MIN_ROWS - 343))
                                | (1 << (SelectSQLParser.MODIFY - 343))
                                | (1 << (SelectSQLParser.MUTEX - 343))
                                | (1 << (SelectSQLParser.MYSQL - 343))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 407))
                            & (
                                (1 << (SelectSQLParser.NAME - 407))
                                | (1 << (SelectSQLParser.NAMES - 407))
                                | (1 << (SelectSQLParser.NCHAR - 407))
                                | (1 << (SelectSQLParser.NEVER - 407))
                                | (1 << (SelectSQLParser.NO - 407))
                                | (1 << (SelectSQLParser.NODEGROUP - 407))
                                | (1 << (SelectSQLParser.NONE - 407))
                                | (1 << (SelectSQLParser.OFFLINE - 407))
                                | (1 << (SelectSQLParser.OFFSET - 407))
                                | (1 << (SelectSQLParser.OJ - 407))
                                | (1 << (SelectSQLParser.OLD_PASSWORD - 407))
                                | (1 << (SelectSQLParser.ONE - 407))
                                | (1 << (SelectSQLParser.ONLINE - 407))
                                | (1 << (SelectSQLParser.ONLY - 407))
                                | (1 << (SelectSQLParser.OPTIMIZER_COSTS - 407))
                                | (1 << (SelectSQLParser.OPTIONS - 407))
                                | (1 << (SelectSQLParser.OWNER - 407))
                                | (1 << (SelectSQLParser.PACK_KEYS - 407))
                                | (1 << (SelectSQLParser.PAGE - 407))
                                | (1 << (SelectSQLParser.PARSER - 407))
                                | (1 << (SelectSQLParser.PARTIAL - 407))
                                | (1 << (SelectSQLParser.PARTITIONING - 407))
                                | (1 << (SelectSQLParser.PARTITIONS - 407))
                                | (1 << (SelectSQLParser.PASSWORD - 407))
                                | (1 << (SelectSQLParser.PHASE - 407))
                                | (1 << (SelectSQLParser.PLUGIN_DIR - 407))
                                | (1 << (SelectSQLParser.PLUGINS - 407))
                                | (1 << (SelectSQLParser.PORT - 407))
                                | (1 << (SelectSQLParser.PRECEDES - 407))
                                | (1 << (SelectSQLParser.PREPARE - 407))
                                | (1 << (SelectSQLParser.PRESERVE - 407))
                                | (1 << (SelectSQLParser.PREV - 407))
                                | (1 << (SelectSQLParser.PROCESSLIST - 407))
                                | (1 << (SelectSQLParser.PROFILE - 407))
                                | (1 << (SelectSQLParser.PROFILES - 407))
                                | (1 << (SelectSQLParser.PROXY - 407))
                                | (1 << (SelectSQLParser.QUERY - 407))
                                | (1 << (SelectSQLParser.QUICK - 407))
                                | (1 << (SelectSQLParser.REBUILD - 407))
                                | (1 << (SelectSQLParser.RECOVER - 407))
                                | (1 << (SelectSQLParser.REDO_BUFFER_SIZE - 407))
                                | (1 << (SelectSQLParser.REDUNDANT - 407))
                                | (1 << (SelectSQLParser.RELAY_LOG_FILE - 407))
                                | (1 << (SelectSQLParser.RELAY_LOG_POS - 407))
                                | (1 << (SelectSQLParser.RELAYLOG - 407))
                                | (1 << (SelectSQLParser.REMOVE - 407))
                                | (1 << (SelectSQLParser.REORGANIZE - 407))
                                | (1 << (SelectSQLParser.REPAIR - 407))
                                | (1 << (SelectSQLParser.REPLICATE_DO_DB - 407))
                                | (1 << (SelectSQLParser.REPLICATE_DO_TABLE - 407))
                                | (1 << (SelectSQLParser.REPLICATE_IGNORE_DB - 407))
                                | (1 << (SelectSQLParser.REPLICATE_IGNORE_TABLE - 407))
                                | (1 << (SelectSQLParser.REPLICATE_REWRITE_DB - 407))
                                | (1 << (SelectSQLParser.REPLICATE_WILD_DO_TABLE - 407))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.REPLICATE_WILD_IGNORE_TABLE
                                ...
                                | (1 << (SelectSQLParser.REPLICATION - 407))
                                | (1 << (SelectSQLParser.RESUME - 407))
                                | (1 << (SelectSQLParser.RETURNS - 407))
                                | (1 << (SelectSQLParser.ROLLBACK - 407))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 471))
                            & (
                                (1 << (SelectSQLParser.ROLLUP - 471))
                                | (1 << (SelectSQLParser.ROTATE - 471))
                                | (1 << (SelectSQLParser.ROW - 471))
                                | (1 << (SelectSQLParser.ROWS - 471))
                                | (1 << (SelectSQLParser.ROW_FORMAT - 471))
                                | (1 << (SelectSQLParser.SAVEPOINT - 471))
                                | (1 << (SelectSQLParser.SCHEDULE - 471))
                                | (1 << (SelectSQLParser.SECURITY - 471))
                                | (1 << (SelectSQLParser.SERVER - 471))
                                | (1 << (SelectSQLParser.SESSION - 471))
                                | (1 << (SelectSQLParser.SHARE - 471))
                                | (1 << (SelectSQLParser.SHARED - 471))
                                | (1 << (SelectSQLParser.SIGNED - 471))
                                | (1 << (SelectSQLParser.SIMPLE - 471))
                                | (1 << (SelectSQLParser.SLAVE - 471))
                                | (1 << (SelectSQLParser.SNAPSHOT - 471))
                                | (1 << (SelectSQLParser.SOCKET - 471))
                                | (1 << (SelectSQLParser.SOME - 471))
                                | (1 << (SelectSQLParser.SOUNDS - 471))
                                | (1 << (SelectSQLParser.SOURCE - 471))
                                | (1 << (SelectSQLParser.SQL_AFTER_GTIDS - 471))
                                | (1 << (SelectSQLParser.SQL_AFTER_MTS_GAPS - 471))
                                | (1 << (SelectSQLParser.SQL_BEFORE_GTIDS - 471))
                                | (1 << (SelectSQLParser.SQL_BUFFER_RESULT - 471))
                                | (1 << (SelectSQLParser.SQL_CACHE - 471))
                                | (1 << (SelectSQLParser.SQL_NO_CACHE - 471))
                                | (1 << (SelectSQLParser.SQL_THREAD - 471))
                                | (1 << (SelectSQLParser.START - 471))
                                | (1 << (SelectSQLParser.STARTS - 471))
                                | (1 << (SelectSQLParser.STATS_AUTO_RECALC - 471))
                                | (1 << (SelectSQLParser.STATS_PERSISTENT - 471))
                                | (1 << (SelectSQLParser.STATS_SAMPLE_PAGES - 471))
                                | (1 << (SelectSQLParser.STATUS - 471))
                                | (1 << (SelectSQLParser.STOP - 471))
                                | (1 << (SelectSQLParser.STORAGE - 471))
                                | (1 << (SelectSQLParser.STRING - 471))
                                | (1 << (SelectSQLParser.SUBJECT - 471))
                                | (1 << (SelectSQLParser.SUBPARTITION - 471))
                                | (1 << (SelectSQLParser.SUBPARTITIONS - 471))
                                | (1 << (SelectSQLParser.SUSPEND - 471))
                                | (1 << (SelectSQLParser.SWAPS - 471))
                                | (1 << (SelectSQLParser.SWITCHES - 471))
                                | (1 << (SelectSQLParser.TABLESPACE - 471))
                                | (1 << (SelectSQLParser.TEMPORARY - 471))
                                | (1 << (SelectSQLParser.TEMPTABLE - 471))
                                | (1 << (SelectSQLParser.THAN - 471))
                                | (1 << (SelectSQLParser.TRANSACTION - 471))
                                | (1 << (SelectSQLParser.TRUNCATE - 471))
                                | (1 << (SelectSQLParser.UNDEFINED - 471))
                                | (1 << (SelectSQLParser.UNDOFILE - 471))
                                | (1 << (SelectSQLParser.UNDO_BUFFER_SIZE - 471))
                                | (1 << (SelectSQLParser.UNKNOWN - 471))
                                | (1 << (SelectSQLParser.UPGRADE - 471))
                                | (1 << (SelectSQLParser.USER - 471))
                                | (1 << (SelectSQLParser.VALIDATION - 471))
                                | (1 << (SelectSQLParser.VALUE - 471))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 535))
                            & (
                                (1 << (SelectSQLParser.VARIABLES - 535))
                                | (1 << (SelectSQLParser.VIEW - 535))
                                | (1 << (SelectSQLParser.WAIT - 535))
                                | (1 << (SelectSQLParser.WARNINGS - 535))
                                | (1 << (SelectSQLParser.WITHOUT - 535))
                                | (1 << (SelectSQLParser.WORK - 535))
                                | (1 << (SelectSQLParser.WRAPPER - 535))
                                | (1 << (SelectSQLParser.X509 - 535))
                                | (1 << (SelectSQLParser.XA - 535))
                                | (1 << (SelectSQLParser.XML - 535))
                                | (1 << (SelectSQLParser.QUARTER - 535))
                                | (1 << (SelectSQLParser.MONTH - 535))
                                | (1 << (SelectSQLParser.DAY - 535))
                                | (1 << (SelectSQLParser.HOUR - 535))
                                | (1 << (SelectSQLParser.MINUTE - 535))
                                | (1 << (SelectSQLParser.WEEK - 535))
                                | (1 << (SelectSQLParser.SECOND - 535))
                                | (1 << (SelectSQLParser.MICROSECOND - 535))
                                | (1 << (SelectSQLParser.TABLES - 535))
                                | (1 << (SelectSQLParser.ROUTINE - 535))
                                | (1 << (SelectSQLParser.EXECUTE - 535))
                                | (1 << (SelectSQLParser.FILE - 535))
                                | (1 << (SelectSQLParser.PROCESS - 535))
                                | (1 << (SelectSQLParser.RELOAD - 535))
                                | (1 << (SelectSQLParser.SHUTDOWN - 535))
                                | (1 << (SelectSQLParser.SUPER - 535))
                                | (1 << (SelectSQLParser.PRIVILEGES - 535))
                                | (1 << (SelectSQLParser.ARMSCII8 - 535))
                                | (1 << (SelectSQLParser.ASCII - 535))
                                | (1 << (SelectSQLParser.BIG5 - 535))
                                | (1 << (SelectSQLParser.CP1250 - 535))
                                | (1 << (SelectSQLParser.CP1251 - 535))
                                | (1 << (SelectSQLParser.CP1256 - 535))
                                | (1 << (SelectSQLParser.CP1257 - 535))
                                | (1 << (SelectSQLParser.CP850 - 535))
                                | (1 << (SelectSQLParser.CP852 - 535))
                                | (1 << (SelectSQLParser.CP866 - 535))
                                | (1 << (SelectSQLParser.CP932 - 535))
                                | (1 << (SelectSQLParser.DEC8 - 535))
                                | (1 << (SelectSQLParser.EUCJPMS - 535))
                                | (1 << (SelectSQLParser.EUCKR - 535))
                                | (1 << (SelectSQLParser.GB2312 - 535))
                                | (1 << (SelectSQLParser.GBK - 535))
                                | (1 << (SelectSQLParser.GEOSTD8 - 535))
                                | (1 << (SelectSQLParser.GREEK - 535))
                                | (1 << (SelectSQLParser.HEBREW - 535))
                                | (1 << (SelectSQLParser.HP8 - 535))
                                | (1 << (SelectSQLParser.KEYBCS2 - 535))
                                | (1 << (SelectSQLParser.KOI8R - 535))
                                | (1 << (SelectSQLParser.KOI8U - 535))
                                | (1 << (SelectSQLParser.LATIN1 - 535))
                                | (1 << (SelectSQLParser.LATIN2 - 535))
                                | (1 << (SelectSQLParser.LATIN5 - 535))
                                | (1 << (SelectSQLParser.LATIN7 - 535))
                                | (1 << (SelectSQLParser.MACCE - 535))
                                | (1 << (SelectSQLParser.MACROMAN - 535))
                                | (1 << (SelectSQLParser.SJIS - 535))
                                | (1 << (SelectSQLParser.SWE7 - 535))
                                | (1 << (SelectSQLParser.TIS620 - 535))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 599))
                            & (
                                (1 << (SelectSQLParser.UCS2 - 599))
                                | (1 << (SelectSQLParser.UJIS - 599))
                                | (1 << (SelectSQLParser.UTF16 - 599))
                                | (1 << (SelectSQLParser.UTF16LE - 599))
                                | (1 << (SelectSQLParser.UTF32 - 599))
                                | (1 << (SelectSQLParser.UTF8 - 599))
                                | (1 << (SelectSQLParser.UTF8MB3 - 599))
                                | (1 << (SelectSQLParser.UTF8MB4 - 599))
                                | (1 << (SelectSQLParser.ARCHIVE - 599))
                                | (1 << (SelectSQLParser.BLACKHOLE - 599))
                                | (1 << (SelectSQLParser.CSV - 599))
                                | (1 << (SelectSQLParser.FEDERATED - 599))
                                | (1 << (SelectSQLParser.INNODB - 599))
                                | (1 << (SelectSQLParser.MEMORY - 599))
                                | (1 << (SelectSQLParser.MRG_MYISAM - 599))
                                | (1 << (SelectSQLParser.MYISAM - 599))
                                | (1 << (SelectSQLParser.NDB - 599))
                                | (1 << (SelectSQLParser.NDBCLUSTER - 599))
                                | (1 << (SelectSQLParser.PERFOMANCE_SCHEMA - 599))
                                | (1 << (SelectSQLParser.REPEATABLE - 599))
                                | (1 << (SelectSQLParser.COMMITTED - 599))
                                | (1 << (SelectSQLParser.UNCOMMITTED - 599))
                                | (1 << (SelectSQLParser.SERIALIZABLE - 599))
                                | (1 << (SelectSQLParser.GEOMETRYCOLLECTION - 599))
                                | (1 << (SelectSQLParser.LINESTRING - 599))
                                | (1 << (SelectSQLParser.MULTILINESTRING - 599))
                                | (1 << (SelectSQLParser.MULTIPOINT - 599))
                                | (1 << (SelectSQLParser.MULTIPOLYGON - 599))
                                | (1 << (SelectSQLParser.POINT - 599))
                                | (1 << (SelectSQLParser.POLYGON - 599))
                                | (1 << (SelectSQLParser.ABS - 599))
                                | (1 << (SelectSQLParser.ACOS - 599))
                                | (1 << (SelectSQLParser.ADDDATE - 599))
                                | (1 << (SelectSQLParser.ADDTIME - 599))
                                | (1 << (SelectSQLParser.AES_DECRYPT - 599))
                                | (1 << (SelectSQLParser.AES_ENCRYPT - 599))
                                | (1 << (SelectSQLParser.AREA - 599))
                                | (1 << (SelectSQLParser.ASBINARY - 599))
                                | (1 << (SelectSQLParser.ASIN - 599))
                                | (1 << (SelectSQLParser.ASTEXT - 599))
                                | (1 << (SelectSQLParser.ASWKB - 599))
                                | (1 << (SelectSQLParser.ASWKT - 599))
                                | (1 << (SelectSQLParser.ASYMMETRIC_DECRYPT - 599))
                                | (1 << (SelectSQLParser.ASYMMETRIC_DERIVE - 599))
                                | (1 << (SelectSQLParser.ASYMMETRIC_ENCRYPT - 599))
                                | (1 << (SelectSQLParser.ASYMMETRIC_SIGN - 599))
                                | (1 << (SelectSQLParser.ASYMMETRIC_VERIFY - 599))
                                | (1 << (SelectSQLParser.ATAN - 599))
                                | (1 << (SelectSQLParser.ATAN2 - 599))
                                | (1 << (SelectSQLParser.BENCHMARK - 599))
                                | (1 << (SelectSQLParser.BIN - 599))
                                | (1 << (SelectSQLParser.BIT_COUNT - 599))
                                | (1 << (SelectSQLParser.BIT_LENGTH - 599))
                                | (1 << (SelectSQLParser.BUFFER - 599))
                                | (1 << (SelectSQLParser.CEIL - 599))
                                | (1 << (SelectSQLParser.CEILING - 599))
                                | (1 << (SelectSQLParser.CENTROID - 599))
                                | (1 << (SelectSQLParser.CHARACTER_LENGTH - 599))
                                | (1 << (SelectSQLParser.CHARSET - 599))
                                | (1 << (SelectSQLParser.CHAR_LENGTH - 599))
                                | (1 << (SelectSQLParser.COERCIBILITY - 599))
                                | (1 << (SelectSQLParser.COLLATION - 599))
                                | (1 << (SelectSQLParser.COMPRESS - 599))
                                | (1 << (SelectSQLParser.CONCAT - 599))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 663))
                            & (
                                (1 << (SelectSQLParser.CONCAT_WS - 663))
                                | (1 << (SelectSQLParser.CONNECTION_ID - 663))
                                | (1 << (SelectSQLParser.CONV - 663))
                                | (1 << (SelectSQLParser.CONVERT_TZ - 663))
                                | (1 << (SelectSQLParser.COS - 663))
                                | (1 << (SelectSQLParser.COT - 663))
                                | (1 << (SelectSQLParser.CRC32 - 663))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.CREATE_ASYMMETRIC_PRIV_KEY - 663
                                    )
                                )
                                | (
                                    1
                                    << (SelectSQLParser.CREATE_ASYMMETRIC_PUB_KEY - 663)
                                )
                                | (1 << (SelectSQLParser.CREATE_DH_PARAMETERS - 663))
                                | (1 << (SelectSQLParser.CREATE_DIGEST - 663))
                                | (1 << (SelectSQLParser.CROSSES - 663))
                                | (1 << (SelectSQLParser.DATEDIFF - 663))
                                | (1 << (SelectSQLParser.DATE_FORMAT - 663))
                                | (1 << (SelectSQLParser.DAYNAME - 663))
                                | (1 << (SelectSQLParser.DAYOFMONTH - 663))
                                | (1 << (SelectSQLParser.DAYOFWEEK - 663))
                                | (1 << (SelectSQLParser.DAYOFYEAR - 663))
                                | (1 << (SelectSQLParser.DECODE - 663))
                                | (1 << (SelectSQLParser.DEGREES - 663))
                                | (1 << (SelectSQLParser.DES_DECRYPT - 663))
                                | (1 << (SelectSQLParser.DES_ENCRYPT - 663))
                                | (1 << (SelectSQLParser.DIMENSION - 663))
                                | (1 << (SelectSQLParser.DISJOINT - 663))
                                | (1 << (SelectSQLParser.ELT - 663))
                                | (1 << (SelectSQLParser.ENCODE - 663))
                                | (1 << (SelectSQLParser.ENCRYPT - 663))
                                | (1 << (SelectSQLParser.ENDPOINT - 663))
                                | (1 << (SelectSQLParser.ENVELOPE - 663))
                                | (1 << (SelectSQLParser.EQUALS - 663))
                                | (1 << (SelectSQLParser.EXP - 663))
                                | (1 << (SelectSQLParser.EXPORT_SET - 663))
                                | (1 << (SelectSQLParser.EXTERIORRING - 663))
                                | (1 << (SelectSQLParser.EXTRACTVALUE - 663))
                                | (1 << (SelectSQLParser.FIELD - 663))
                                | (1 << (SelectSQLParser.FIND_IN_SET - 663))
                                | (1 << (SelectSQLParser.FLOOR - 663))
                                | (1 << (SelectSQLParser.FORMAT - 663))
                                | (1 << (SelectSQLParser.FOUND_ROWS - 663))
                                | (1 << (SelectSQLParser.FROM_BASE64 - 663))
                                | (1 << (SelectSQLParser.FROM_DAYS - 663))
                                | (1 << (SelectSQLParser.FROM_UNIXTIME - 663))
                                | (1 << (SelectSQLParser.GEOMCOLLFROMTEXT - 663))
                                | (1 << (SelectSQLParser.GEOMCOLLFROMWKB - 663))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.GEOMETRYCOLLECTIONFROMTEXT - 663
                                    )
                                )
                                | (
                                    1
                                    << (SelectSQLParser.GEOMETRYCOLLECTIONFROMWKB - 663)
                                )
                                | (1 << (SelectSQLParser.GEOMETRYFROMTEXT - 663))
                                | (1 << (SelectSQLParser.GEOMETRYFROMWKB - 663))
                                | (1 << (SelectSQLParser.GEOMETRYN - 663))
                                | (1 << (SelectSQLParser.GEOMETRYTYPE - 663))
                                | (1 << (SelectSQLParser.GEOMFROMTEXT - 663))
                                | (1 << (SelectSQLParser.GEOMFROMWKB - 663))
                                | (1 << (SelectSQLParser.GET_FORMAT - 663))
                                | (1 << (SelectSQLParser.GET_LOCK - 663))
                                | (1 << (SelectSQLParser.GLENGTH - 663))
                                | (1 << (SelectSQLParser.GREATEST - 663))
                                | (1 << (SelectSQLParser.GTID_SUBSET - 663))
                                | (1 << (SelectSQLParser.GTID_SUBTRACT - 663))
                                | (1 << (SelectSQLParser.HEX - 663))
                                | (1 << (SelectSQLParser.IFNULL - 663))
                                | (1 << (SelectSQLParser.INET6_ATON - 663))
                                | (1 << (SelectSQLParser.INET6_NTOA - 663))
                                | (1 << (SelectSQLParser.INET_ATON - 663))
                                | (1 << (SelectSQLParser.INET_NTOA - 663))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 727))
                            & (
                                (1 << (SelectSQLParser.INSTR - 727))
                                | (1 << (SelectSQLParser.INTERIORRINGN - 727))
                                | (1 << (SelectSQLParser.INTERSECTS - 727))
                                | (1 << (SelectSQLParser.ISCLOSED - 727))
                                | (1 << (SelectSQLParser.ISEMPTY - 727))
                                | (1 << (SelectSQLParser.ISNULL - 727))
                                | (1 << (SelectSQLParser.ISSIMPLE - 727))
                                | (1 << (SelectSQLParser.IS_FREE_LOCK - 727))
                                | (1 << (SelectSQLParser.IS_IPV4 - 727))
                                | (1 << (SelectSQLParser.IS_IPV4_COMPAT - 727))
                                | (1 << (SelectSQLParser.IS_IPV4_MAPPED - 727))
                                | (1 << (SelectSQLParser.IS_IPV6 - 727))
                                | (1 << (SelectSQLParser.IS_USED_LOCK - 727))
                                | (1 << (SelectSQLParser.LAST_INSERT_ID - 727))
                                | (1 << (SelectSQLParser.LCASE - 727))
                                | (1 << (SelectSQLParser.LEAST - 727))
                                | (1 << (SelectSQLParser.LENGTH - 727))
                                | (1 << (SelectSQLParser.LINEFROMTEXT - 727))
                                | (1 << (SelectSQLParser.LINEFROMWKB - 727))
                                | (1 << (SelectSQLParser.LINESTRINGFROMTEXT - 727))
                                | (1 << (SelectSQLParser.LINESTRINGFROMWKB - 727))
                                | (1 << (SelectSQLParser.LN - 727))
                                | (1 << (SelectSQLParser.LOAD_FILE - 727))
                                | (1 << (SelectSQLParser.LOCATE - 727))
                                | (1 << (SelectSQLParser.LOG - 727))
                                | (1 << (SelectSQLParser.LOG10 - 727))
                                | (1 << (SelectSQLParser.LOG2 - 727))
                                | (1 << (SelectSQLParser.LOWER - 727))
                                | (1 << (SelectSQLParser.LPAD - 727))
                                | (1 << (SelectSQLParser.LTRIM - 727))
                                | (1 << (SelectSQLParser.MAKEDATE - 727))
                                | (1 << (SelectSQLParser.MAKETIME - 727))
                                | (1 << (SelectSQLParser.MAKE_SET - 727))
                                | (1 << (SelectSQLParser.MASTER_POS_WAIT - 727))
                                | (1 << (SelectSQLParser.MBRCONTAINS - 727))
                                | (1 << (SelectSQLParser.MBRDISJOINT - 727))
                                | (1 << (SelectSQLParser.MBREQUAL - 727))
                                | (1 << (SelectSQLParser.MBRINTERSECTS - 727))
                                | (1 << (SelectSQLParser.MBROVERLAPS - 727))
                                | (1 << (SelectSQLParser.MBRTOUCHES - 727))
                                | (1 << (SelectSQLParser.MBRWITHIN - 727))
                                | (1 << (SelectSQLParser.MD5 - 727))
                                | (1 << (SelectSQLParser.MLINEFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MLINEFROMWKB - 727))
                                | (1 << (SelectSQLParser.MONTHNAME - 727))
                                | (1 << (SelectSQLParser.MPOINTFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MPOINTFROMWKB - 727))
                                | (1 << (SelectSQLParser.MPOLYFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MPOLYFROMWKB - 727))
                                | (1 << (SelectSQLParser.MULTILINESTRINGFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MULTILINESTRINGFROMWKB - 727))
                                | (1 << (SelectSQLParser.MULTIPOINTFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MULTIPOINTFROMWKB - 727))
                                | (1 << (SelectSQLParser.MULTIPOLYGONFROMTEXT - 727))
                                | (1 << (SelectSQLParser.MULTIPOLYGONFROMWKB - 727))
                                | (1 << (SelectSQLParser.NAME_CONST - 727))
                                | (1 << (SelectSQLParser.NULLIF - 727))
                                | (1 << (SelectSQLParser.NUMGEOMETRIES - 727))
                                | (1 << (SelectSQLParser.NUMINTERIORRINGS - 727))
                                | (1 << (SelectSQLParser.NUMPOINTS - 727))
                                | (1 << (SelectSQLParser.OCT - 727))
                                | (1 << (SelectSQLParser.OCTET_LENGTH - 727))
                                | (1 << (SelectSQLParser.ORD - 727))
                                | (1 << (SelectSQLParser.OVERLAPS - 727))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 791))
                            & (
                                (1 << (SelectSQLParser.PERIOD_ADD - 791))
                                | (1 << (SelectSQLParser.PERIOD_DIFF - 791))
                                | (1 << (SelectSQLParser.PI - 791))
                                | (1 << (SelectSQLParser.POINTFROMTEXT - 791))
                                | (1 << (SelectSQLParser.POINTFROMWKB - 791))
                                | (1 << (SelectSQLParser.POINTN - 791))
                                | (1 << (SelectSQLParser.POLYFROMTEXT - 791))
                                | (1 << (SelectSQLParser.POLYFROMWKB - 791))
                                | (1 << (SelectSQLParser.POLYGONFROMTEXT - 791))
                                | (1 << (SelectSQLParser.POLYGONFROMWKB - 791))
                                | (1 << (SelectSQLParser.POW - 791))
                                | (1 << (SelectSQLParser.POWER - 791))
                                | (1 << (SelectSQLParser.QUOTE - 791))
                                | (1 << (SelectSQLParser.RADIANS - 791))
                                | (1 << (SelectSQLParser.RAND - 791))
                                | (1 << (SelectSQLParser.RANDOM_BYTES - 791))
                                | (1 << (SelectSQLParser.RELEASE_LOCK - 791))
                                | (1 << (SelectSQLParser.REVERSE - 791))
                                | (1 << (SelectSQLParser.ROUND - 791))
                                | (1 << (SelectSQLParser.ROW_COUNT - 791))
                                | (1 << (SelectSQLParser.RPAD - 791))
                                | (1 << (SelectSQLParser.RTRIM - 791))
                                | (1 << (SelectSQLParser.SEC_TO_TIME - 791))
                                | (1 << (SelectSQLParser.SESSION_USER - 791))
                                | (1 << (SelectSQLParser.SHA - 791))
                                | (1 << (SelectSQLParser.SHA1 - 791))
                                | (1 << (SelectSQLParser.SHA2 - 791))
                                | (1 << (SelectSQLParser.SIGN - 791))
                                | (1 << (SelectSQLParser.SIN - 791))
                                | (1 << (SelectSQLParser.SLEEP - 791))
                                | (1 << (SelectSQLParser.SOUNDEX - 791))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.SQL_THREAD_WAIT_AFTER_GTIDS
                                ...
                                | (1 << (SelectSQLParser.SQRT - 791))
                                | (1 << (SelectSQLParser.SRID - 791))
                                | (1 << (SelectSQLParser.STARTPOINT - 791))
                                | (1 << (SelectSQLParser.STRCMP - 791))
                                | (1 << (SelectSQLParser.STR_TO_DATE - 791))
                                | (1 << (SelectSQLParser.ST_AREA - 791))
                                | (1 << (SelectSQLParser.ST_ASBINARY - 791))
                                | (1 << (SelectSQLParser.ST_ASTEXT - 791))
                                | (1 << (SelectSQLParser.ST_ASWKB - 791))
                                | (1 << (SelectSQLParser.ST_ASWKT - 791))
                                | (1 << (SelectSQLParser.ST_BUFFER - 791))
                                | (1 << (SelectSQLParser.ST_CENTROID - 791))
                                | (1 << (SelectSQLParser.ST_CONTAINS - 791))
                                | (1 << (SelectSQLParser.ST_CROSSES - 791))
                                | (1 << (SelectSQLParser.ST_DIFFERENCE - 791))
                                | (1 << (SelectSQLParser.ST_DIMENSION - 791))
                                | (1 << (SelectSQLParser.ST_DISJOINT - 791))
                                | (1 << (SelectSQLParser.ST_DISTANCE - 791))
                                | (1 << (SelectSQLParser.ST_ENDPOINT - 791))
                                | (1 << (SelectSQLParser.ST_ENVELOPE - 791))
                                | (1 << (SelectSQLParser.ST_EQUALS - 791))
                                | (1 << (SelectSQLParser.ST_EXTERIORRING - 791))
                                | (1 << (SelectSQLParser.ST_GEOMCOLLFROMTEXT - 791))
                                | (1 << (SelectSQLParser.ST_GEOMCOLLFROMTXT - 791))
                                | (1 << (SelectSQLParser.ST_GEOMCOLLFROMWKB - 791))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.ST_GEOMETRYCOLLECTIONFROMTEXT
                                ...
                                | (1 << (SelectSQLParser.ST_GEOMETRYFROMTEXT - 791))
                                | (1 << (SelectSQLParser.ST_GEOMETRYFROMWKB - 791))
                                | (1 << (SelectSQLParser.ST_GEOMETRYN - 791))
                                | (1 << (SelectSQLParser.ST_GEOMETRYTYPE - 791))
                                | (1 << (SelectSQLParser.ST_GEOMFROMTEXT - 791))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 855))
                            & (
                                (1 << (SelectSQLParser.ST_GEOMFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_INTERIORRINGN - 855))
                                | (1 << (SelectSQLParser.ST_INTERSECTION - 855))
                                | (1 << (SelectSQLParser.ST_INTERSECTS - 855))
                                | (1 << (SelectSQLParser.ST_ISCLOSED - 855))
                                | (1 << (SelectSQLParser.ST_ISEMPTY - 855))
                                | (1 << (SelectSQLParser.ST_ISSIMPLE - 855))
                                | (1 << (SelectSQLParser.ST_LINEFROMTEXT - 855))
                                | (1 << (SelectSQLParser.ST_LINEFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_LINESTRINGFROMTEXT - 855))
                                | (1 << (SelectSQLParser.ST_LINESTRINGFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_NUMGEOMETRIES - 855))
                                | (1 << (SelectSQLParser.ST_NUMINTERIORRING - 855))
                                | (1 << (SelectSQLParser.ST_NUMINTERIORRINGS - 855))
                                | (1 << (SelectSQLParser.ST_NUMPOINTS - 855))
                                | (1 << (SelectSQLParser.ST_OVERLAPS - 855))
                                | (1 << (SelectSQLParser.ST_POINTFROMTEXT - 855))
                                | (1 << (SelectSQLParser.ST_POINTFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_POINTN - 855))
                                | (1 << (SelectSQLParser.ST_POLYFROMTEXT - 855))
                                | (1 << (SelectSQLParser.ST_POLYFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_POLYGONFROMTEXT - 855))
                                | (1 << (SelectSQLParser.ST_POLYGONFROMWKB - 855))
                                | (1 << (SelectSQLParser.ST_SRID - 855))
                                | (1 << (SelectSQLParser.ST_STARTPOINT - 855))
                                | (1 << (SelectSQLParser.ST_SYMDIFFERENCE - 855))
                                | (1 << (SelectSQLParser.ST_TOUCHES - 855))
                                | (1 << (SelectSQLParser.ST_UNION - 855))
                                | (1 << (SelectSQLParser.ST_WITHIN - 855))
                                | (1 << (SelectSQLParser.ST_X - 855))
                                | (1 << (SelectSQLParser.ST_Y - 855))
                                | (1 << (SelectSQLParser.SUBDATE - 855))
                                | (1 << (SelectSQLParser.SUBSTRING_INDEX - 855))
                                | (1 << (SelectSQLParser.SUBTIME - 855))
                                | (1 << (SelectSQLParser.SYSTEM_USER - 855))
                                | (1 << (SelectSQLParser.TAN - 855))
                                | (1 << (SelectSQLParser.TIMEDIFF - 855))
                                | (1 << (SelectSQLParser.TIMESTAMPADD - 855))
                                | (1 << (SelectSQLParser.TIMESTAMPDIFF - 855))
                                | (1 << (SelectSQLParser.TIME_FORMAT - 855))
                                | (1 << (SelectSQLParser.TIME_TO_SEC - 855))
                                | (1 << (SelectSQLParser.TOUCHES - 855))
                                | (1 << (SelectSQLParser.TO_BASE64 - 855))
                                | (1 << (SelectSQLParser.TO_DAYS - 855))
                                | (1 << (SelectSQLParser.TO_SECONDS - 855))
                                | (1 << (SelectSQLParser.UCASE - 855))
                                | (1 << (SelectSQLParser.UNCOMPRESS - 855))
                                | (1 << (SelectSQLParser.UNCOMPRESSED_LENGTH - 855))
                                | (1 << (SelectSQLParser.UNHEX - 855))
                                | (1 << (SelectSQLParser.UNIX_TIMESTAMP - 855))
                                | (1 << (SelectSQLParser.UPDATEXML - 855))
                                | (1 << (SelectSQLParser.UPPER - 855))
                                | (1 << (SelectSQLParser.UUID - 855))
                                | (1 << (SelectSQLParser.UUID_SHORT - 855))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.VALIDATE_PASSWORD_STRENGTH - 855
                                    )
                                )
                                | (1 << (SelectSQLParser.VERSION - 855))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS
                                ...
                                | (1 << (SelectSQLParser.WEEKDAY - 855))
                                | (1 << (SelectSQLParser.WEEKOFYEAR - 855))
                                | (1 << (SelectSQLParser.WEIGHT_STRING - 855))
                                | (1 << (SelectSQLParser.WITHIN - 855))
                                | (1 << (SelectSQLParser.YEARWEEK - 855))
                                | (1 << (SelectSQLParser.Y_FUNCTION - 855))
                                | (1 << (SelectSQLParser.X_FUNCTION - 855))
                            )
                        )
                        != 0
                    )
                    or (
                        ...
                        and (
                            (1 << (_la - 931))
                            & (
                                (1 << (SelectSQLParser.PLUS - 931))
                                | (1 << (SelectSQLParser.MINUS - 931))
                                | (1 << (SelectSQLParser.EXCLAMATION_SYMBOL - 931))
                                | (1 << (SelectSQLParser.BIT_NOT_OP - 931))
                                | (1 << (SelectSQLParser.LR_BRACKET - 931))
                                | (1 << (SelectSQLParser.ZERO_DECIMAL - 931))
                                | (1 << (SelectSQLParser.ONE_DECIMAL - 931))
                                | (1 << (SelectSQLParser.TWO_DECIMAL - 931))
                                | (
                                    1
                                    << (
                                        SelectSQLParser.CHARSET_REVERSE_QOUTE_STRING
                                ...
                                | (1 << (SelectSQLParser.STRING_LITERAL - 931))
                                | (1 << (SelectSQLParser.DECIMAL_LITERAL - 931))
                                | (1 << (SelectSQLParser.HEXADECIMAL_LITERAL - 931))
                                | (1 << (SelectSQLParser.REAL_LITERAL - 931))
                                | (1 << (SelectSQLParser.NULL_SPEC_LITERAL - 931))
                                | (1 << (SelectSQLParser.BIT_STRING - 931))
                                | (1 << (SelectSQLParser.STRING_CHARSET_NAME - 931))
                                | (1 << (SelectSQLParser.ID - 931))
                                | (1 << (SelectSQLParser.REVERSE_QUOTE_ID - 931))
                                | (1 << (SelectSQLParser.LOCAL_ID - 931))
                                | (1 << (SelectSQLParser.GLOBAL_ID - 931))
                            )
                        )
                        != 0
                    )
    ...
    class PositionFunctionCallContext(SpecificFunctionContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.SpecificFunctionContext
            super().__init__(parser)
    ...
    class WeightFunctionCallContext(SpecificFunctionContext):
        ...
        def levelsInWeightString(self):
            return self.getTypedRuleContext(
                SelectSQLParser.LevelsInWeightStringContext, 0
            )
    ...
    class CaseFunctionCallContext(SpecificFunctionContext):
        ...
        def caseFuncAlternative(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.CaseFuncAlternativeContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.CaseFuncAlternativeContext, i
                )
    ...
    def specificFunction(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.CURRENT_USER
                    or (
                        (((_la - 225)) & ~0x3F) == 0
                        and (
                            (1 << (_la - 225))
                            & (
                                (1 << (SelectSQLParser.CURRENT_DATE - 225))
                                | (1 << (SelectSQLParser.CURRENT_TIME - 225))
                                | (1 << (SelectSQLParser.CURRENT_TIMESTAMP - 225))
                                | (1 << (SelectSQLParser.LOCALTIME - 225))
                            )
                        )
                        != 0
                    )
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.SUBSTR or _la == SelectSQLParser.SUBSTRING
                ):
                    self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.BOTH
                    or _la == SelectSQLParser.LEADING
                    or _la == SelectSQLParser.TRAILING
                ):
                ...
                if _la == SelectSQLParser.AS:
                    ...
                    _la = self._input.LA(1)
                    if not (
                        _la == SelectSQLParser.CHAR or _la == SelectSQLParser.BINARY
                    ):
    ...
    def caseFuncAlternative(self):
        ...
        localctx = SelectSQLParser.CaseFuncAlternativeContext(
            self, self._ctx, self.state
        )
    ...
    class LevelWeightRangeContext(LevelsInWeightStringContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.LevelsInWeightStringContext
            super().__init__(parser)
    ...
    class LevelWeightListContext(LevelsInWeightStringContext):
        ...
        def levelInWeightListElement(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    SelectSQLParser.LevelInWeightListElementContext
                )
            else:
                return self.getTypedRuleContext(
                    SelectSQLParser.LevelInWeightListElementContext, i
                )
    ...
    def levelsInWeightString(self):
        ...
        localctx = SelectSQLParser.LevelsInWeightStringContext(
            self, self._ctx, self.state
        )
    ...
    def levelInWeightListElement(self):
        ...
        localctx = SelectSQLParser.LevelInWeightListElementContext(
            self, self._ctx, self.state
        )
        ...
        try:
            ...
            _la = self._input.LA(1)
            if (
                _la == SelectSQLParser.ASC
                or _la == SelectSQLParser.DESC
                or _la == SelectSQLParser.REVERSE
            ):
                self.state = 1077
    ...
    def aggregateWindowedFunction(self):
        ...
        localctx = SelectSQLParser.AggregateWindowedFunctionContext(
            self, self._ctx, self.state
        )
        ...
        try:
            ...
            if la_ == 1:
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 209))
                            & (
                                (1 << (SelectSQLParser.AVG - 209))
                                | (1 << (SelectSQLParser.MAX - 209))
                                | (1 << (SelectSQLParser.MIN - 209))
                                | (1 << (SelectSQLParser.SUM - 209))
                            )
                        )
                        != 0
                    )
                ...
                if _la == SelectSQLParser.ALL or _la == SelectSQLParser.DISTINCT:
                    ...
                    _la = self._input.LA(1)
                    if not (
                        _la == SelectSQLParser.ALL or _la == SelectSQLParser.DISTINCT
                    ):
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 210))
                            & (
                                (1 << (SelectSQLParser.BIT_AND - 210))
                                | (1 << (SelectSQLParser.BIT_OR - 210))
                                | (1 << (SelectSQLParser.BIT_XOR - 210))
                                | (1 << (SelectSQLParser.STD - 210))
                                | (1 << (SelectSQLParser.STDDEV - 210))
                                | (1 << (SelectSQLParser.STDDEV_POP - 210))
                                | (1 << (SelectSQLParser.STDDEV_SAMP - 210))
                                | (1 << (SelectSQLParser.VAR_POP - 210))
                                | (1 << (SelectSQLParser.VAR_SAMP - 210))
                                | (1 << (SelectSQLParser.VARIANCE - 210))
                            )
                        )
                        != 0
                    )
    ...
    def scalarFunctionName(self):
        ...
        localctx = SelectSQLParser.ScalarFunctionNameContext(
            self, self._ctx, self.state
        )
    ...
    def passwordFunctionClause(self):
        ...
        localctx = SelectSQLParser.PasswordFunctionClauseContext(
            self, self._ctx, self.state
        )
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.OLD_PASSWORD or _la == SelectSQLParser.PASSWORD
            ):
    ...
    class FunctionArgsContext(ParserRuleContext):
        ...
        def fullColumnName(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.FullColumnNameContext, i
                )
    ...
    class IsExpressionContext(ExpressionContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.ExpressionContext
            super().__init__(parser)
    ...
    def expression(self, _p: int = 0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.NOT
                    or _la == SelectSQLParser.EXCLAMATION_SYMBOL
                ):
                ...
                _la = self._input.LA(1)
                if not (
                    _la == SelectSQLParser.FALSE
                    or _la == SelectSQLParser.TRUE
                    or _la == SelectSQLParser.UNKNOWN
                ):
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    _prevctx = localctx
                    localctx = SelectSQLParser.LogicalExpressionContext(
                        self,
                        SelectSQLParser.ExpressionContext(
    ...
    class SoundsLikePredicateContext(PredicateContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.PredicateContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class SubqueryComparasionPredicateContext(PredicateContext):
        ...
        def comparisonOperator(self):
            return self.getTypedRuleContext(
                SelectSQLParser.ComparisonOperatorContext, 0
            )
        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = SelectSQLParser.BinaryComparasionPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        )
                        localctx.left = _prevctx
                        self.pushNewRecursionContext(
                            localctx, _startState, self.RULE_predicate
                        )
                        self.state = 1221
                        ...
                        localctx = SelectSQLParser.BetweenPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = SelectSQLParser.SoundsLikePredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = SelectSQLParser.RegexpPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        _la = self._input.LA(1)
                        if not (
                            _la == SelectSQLParser.REGEXP
                            or _la == SelectSQLParser.RLIKE
                        ):
                        ...
                        localctx = SelectSQLParser.InPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = SelectSQLParser.IsNullPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = SelectSQLParser.SubqueryComparasionPredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        if not (
                            _la == SelectSQLParser.ALL
                            or _la == SelectSQLParser.ANY
                            or _la == SelectSQLParser.SOME
                        ):
                        ...
                        localctx = SelectSQLParser.LikePredicateContext(
                            self,
                            SelectSQLParser.PredicateContext(
                                self, _parentctx, _parentState
                            ),
    ...
    class UnaryExpressionAtomContext(ExpressionAtomContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a SelectSQLParser.ExpressionAtomContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class MathExpressionAtomContext(ExpressionAtomContext):
        ...
        def expressionAtom(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    SelectSQLParser.ExpressionAtomContext, i
                )
    ...
    def expressionAtom(self, _p: int = 0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = SelectSQLParser.FullColumnNameExpressionAtomContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = SelectSQLParser.FunctionCallExpressionAtomContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = SelectSQLParser.NestedRowExpressionAtomContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = SelectSQLParser.BitExpressionAtomContext(
                            self,
                            SelectSQLParser.ExpressionAtomContext(
                                self, _parentctx, _parentState
                            ),
                        )
                        localctx.left = _prevctx
                        self.pushNewRecursionContext(
                            localctx, _startState, self.RULE_expressionAtom
                        )
                        self.state = 1328
                        if not self.precpred(self._ctx, 2):
                            from antlr4.error.Errors import FailedPredicateException
                        ...
                        localctx = SelectSQLParser.MathExpressionAtomContext(
                            self,
                            SelectSQLParser.ExpressionAtomContext(
                                self, _parentctx, _parentState
                            ),
                        ...
                        localctx = SelectSQLParser.CollateExpressionAtomContext(
                            self,
                            SelectSQLParser.ExpressionAtomContext(
                                self, _parentctx, _parentState
                            ),
    ...
    def comparisonOperator(self):
        ...
        localctx = SelectSQLParser.ComparisonOperatorContext(
            self, self._ctx, self.state
        )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 928))
                        & (
                            (1 << (SelectSQLParser.STAR - 928))
                            | (1 << (SelectSQLParser.DIVIDE - 928))
                            | (1 << (SelectSQLParser.MODULE - 928))
                            | (1 << (SelectSQLParser.PLUS - 928))
                            | (1 << (SelectSQLParser.MINUSMINUS - 928))
                            | (1 << (SelectSQLParser.MINUS - 928))
                            | (1 << (SelectSQLParser.DIV - 928))
                            | (1 << (SelectSQLParser.MOD - 928))
                        )
                    )
                    != 0
                )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 567))
                        & (
                            (1 << (SelectSQLParser.ARMSCII8 - 567))
                            | (1 << (SelectSQLParser.ASCII - 567))
                            | (1 << (SelectSQLParser.BIG5 - 567))
                            | (1 << (SelectSQLParser.CP1250 - 567))
                            | (1 << (SelectSQLParser.CP1251 - 567))
                            | (1 << (SelectSQLParser.CP1256 - 567))
                            | (1 << (SelectSQLParser.CP1257 - 567))
                            | (1 << (SelectSQLParser.CP850 - 567))
                            | (1 << (SelectSQLParser.CP852 - 567))
                            | (1 << (SelectSQLParser.CP866 - 567))
                            | (1 << (SelectSQLParser.CP932 - 567))
                            | (1 << (SelectSQLParser.DEC8 - 567))
                            | (1 << (SelectSQLParser.EUCJPMS - 567))
                            | (1 << (SelectSQLParser.EUCKR - 567))
                            | (1 << (SelectSQLParser.GB2312 - 567))
                            | (1 << (SelectSQLParser.GBK - 567))
                            | (1 << (SelectSQLParser.GEOSTD8 - 567))
                            | (1 << (SelectSQLParser.GREEK - 567))
                            | (1 << (SelectSQLParser.HEBREW - 567))
                            | (1 << (SelectSQLParser.HP8 - 567))
                            | (1 << (SelectSQLParser.KEYBCS2 - 567))
                            | (1 << (SelectSQLParser.KOI8R - 567))
                            | (1 << (SelectSQLParser.KOI8U - 567))
                            | (1 << (SelectSQLParser.LATIN1 - 567))
                            | (1 << (SelectSQLParser.LATIN2 - 567))
                            | (1 << (SelectSQLParser.LATIN5 - 567))
                            | (1 << (SelectSQLParser.LATIN7 - 567))
                            | (1 << (SelectSQLParser.MACCE - 567))
                            | (1 << (SelectSQLParser.MACROMAN - 567))
                            | (1 << (SelectSQLParser.SJIS - 567))
                            | (1 << (SelectSQLParser.SWE7 - 567))
                            | (1 << (SelectSQLParser.TIS620 - 567))
                            | (1 << (SelectSQLParser.UCS2 - 567))
                            | (1 << (SelectSQLParser.UJIS - 567))
                            | (1 << (SelectSQLParser.UTF16 - 567))
                            | (1 << (SelectSQLParser.UTF16LE - 567))
                            | (1 << (SelectSQLParser.UTF32 - 567))
                            | (1 << (SelectSQLParser.UTF8 - 567))
                            | (1 << (SelectSQLParser.UTF8MB3 - 567))
                            | (1 << (SelectSQLParser.UTF8MB4 - 567))
                        )
                    )
                    != 0
                )
    ...
    def transactionLevelBase(self):
        ...
        localctx = SelectSQLParser.TransactionLevelBaseContext(
            self, self._ctx, self.state
        )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 618))
                        & (
                            (1 << (SelectSQLParser.REPEATABLE - 618))
                            | (1 << (SelectSQLParser.COMMITTED - 618))
                            | (1 << (SelectSQLParser.UNCOMMITTED - 618))
                            | (1 << (SelectSQLParser.SERIALIZABLE - 618))
                        )
                    )
                    != 0
                )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 558))
                        & (
                            (1 << (SelectSQLParser.TABLES - 558))
                            | (1 << (SelectSQLParser.ROUTINE - 558))
                            | (1 << (SelectSQLParser.EXECUTE - 558))
                            | (1 << (SelectSQLParser.FILE - 558))
                            | (1 << (SelectSQLParser.PROCESS - 558))
                            | (1 << (SelectSQLParser.RELOAD - 558))
                            | (1 << (SelectSQLParser.SHUTDOWN - 558))
                            | (1 << (SelectSQLParser.SUPER - 558))
                            | (1 << (SelectSQLParser.PRIVILEGES - 558))
                        )
                    )
                    != 0
                )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 550))
                        & (
                            (1 << (SelectSQLParser.QUARTER - 550))
                            | (1 << (SelectSQLParser.MONTH - 550))
                            | (1 << (SelectSQLParser.DAY - 550))
                            | (1 << (SelectSQLParser.HOUR - 550))
                            | (1 << (SelectSQLParser.MINUTE - 550))
                            | (1 << (SelectSQLParser.WEEK - 550))
                            | (1 << (SelectSQLParser.SECOND - 550))
                            | (1 << (SelectSQLParser.MICROSECOND - 550))
                        )
                    )
                    != 0
                )
                ...
                (
                    ...
                    and (
                        ...
                        & (
                            (1 << (SelectSQLParser.DATE - 180))
                            | (1 << (SelectSQLParser.TIME - 180))
                            | (1 << (SelectSQLParser.TIMESTAMP - 180))
                            | (1 << (SelectSQLParser.DATETIME - 180))
                            | (1 << (SelectSQLParser.YEAR - 180))
                            | (1 << (SelectSQLParser.TEXT - 180))
                            | (1 << (SelectSQLParser.ENUM - 180))
                        )
                    )
                    != 0
                )
            ...
            if not (
                (
                    ...
                    and (
                        (1 << (_la - 244))
                        & (
                            (1 << (SelectSQLParser.ACCOUNT - 244))
                            | (1 << (SelectSQLParser.ACTION - 244))
                            | (1 << (SelectSQLParser.AFTER - 244))
                            | (1 << (SelectSQLParser.AGGREGATE - 244))
                            | (1 << (SelectSQLParser.ALGORITHM - 244))
                            | (1 << (SelectSQLParser.ANY - 244))
                            | (1 << (SelectSQLParser.AT - 244))
                            | (1 << (SelectSQLParser.AUTHORS - 244))
                            | (1 << (SelectSQLParser.AUTOCOMMIT - 244))
                            | (1 << (SelectSQLParser.AUTOEXTEND_SIZE - 244))
                            | (1 << (SelectSQLParser.AUTO_INCREMENT - 244))
                            | (1 << (SelectSQLParser.AVG_ROW_LENGTH - 244))
                            | (1 << (SelectSQLParser.BEGIN - 244))
                            | (1 << (SelectSQLParser.BINLOG - 244))
                            | (1 << (SelectSQLParser.BIT - 244))
                            | (1 << (SelectSQLParser.BLOCK - 244))
                            | (1 << (SelectSQLParser.BOOL - 244))
                            | (1 << (SelectSQLParser.BOOLEAN - 244))
                            | (1 << (SelectSQLParser.BTREE - 244))
                            | (1 << (SelectSQLParser.CASCADED - 244))
                            | (1 << (SelectSQLParser.CHAIN - 244))
                            | (1 << (SelectSQLParser.CHANNEL - 244))
                            | (1 << (SelectSQLParser.CHECKSUM - 244))
                            | (1 << (SelectSQLParser.CIPHER - 244))
                            | (1 << (SelectSQLParser.CLIENT - 244))
                            | (1 << (SelectSQLParser.COALESCE - 244))
                            | (1 << (SelectSQLParser.CODE - 244))
                            | (1 << (SelectSQLParser.COLUMNS - 244))
                            | (1 << (SelectSQLParser.COLUMN_FORMAT - 244))
                            | (1 << (SelectSQLParser.COMMENT - 244))
                            | (1 << (SelectSQLParser.COMMIT - 244))
                            | (1 << (SelectSQLParser.COMPACT - 244))
                            | (1 << (SelectSQLParser.COMPLETION - 244))
                            | (1 << (SelectSQLParser.COMPRESSED - 244))
                            | (1 << (SelectSQLParser.COMPRESSION - 244))
                            | (1 << (SelectSQLParser.CONCURRENT - 244))
                            | (1 << (SelectSQLParser.CONNECTION - 244))
                            | (1 << (SelectSQLParser.CONSISTENT - 244))
                            | (1 << (SelectSQLParser.CONTAINS - 244))
                            | (1 << (SelectSQLParser.CONTEXT - 244))
                            | (1 << (SelectSQLParser.CONTRIBUTORS - 244))
                            | (1 << (SelectSQLParser.COPY - 244))
                            | (1 << (SelectSQLParser.CPU - 244))
                            | (1 << (SelectSQLParser.DATA - 244))
                            | (1 << (SelectSQLParser.DATAFILE - 244))
                            | (1 << (SelectSQLParser.DEALLOCATE - 244))
                            | (1 << (SelectSQLParser.DEFAULT_AUTH - 244))
                            | (1 << (SelectSQLParser.DEFINER - 244))
                            | (1 << (SelectSQLParser.DELAY_KEY_WRITE - 244))
                            | (1 << (SelectSQLParser.DIRECTORY - 244))
                            | (1 << (SelectSQLParser.DISABLE - 244))
                            | (1 << (SelectSQLParser.DISCARD - 244))
                            | (1 << (SelectSQLParser.DISK - 244))
                            | (1 << (SelectSQLParser.DO - 244))
                            | (1 << (SelectSQLParser.DUMPFILE - 244))
                            | (1 << (SelectSQLParser.DUPLICATE - 244))
                            | (1 << (SelectSQLParser.DYNAMIC - 244))
                            | (1 << (SelectSQLParser.ENABLE - 244))
                            | (1 << (SelectSQLParser.ENCRYPTION - 244))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 308))
                        & (
                            (1 << (SelectSQLParser.ENDS - 308))
                            | (1 << (SelectSQLParser.ENGINE - 308))
                            | (1 << (SelectSQLParser.ENGINES - 308))
                            | (1 << (SelectSQLParser.ERROR - 308))
                            | (1 << (SelectSQLParser.ERRORS - 308))
                            | (1 << (SelectSQLParser.ESCAPE - 308))
                            | (1 << (SelectSQLParser.EVEN - 308))
                            | (1 << (SelectSQLParser.EVENT - 308))
                            | (1 << (SelectSQLParser.EVENTS - 308))
                            | (1 << (SelectSQLParser.EVERY - 308))
                            | (1 << (SelectSQLParser.EXCHANGE - 308))
                            | (1 << (SelectSQLParser.EXCLUSIVE - 308))
                            | (1 << (SelectSQLParser.EXPIRE - 308))
                            | (1 << (SelectSQLParser.EXTENT_SIZE - 308))
                            | (1 << (SelectSQLParser.FAULTS - 308))
                            | (1 << (SelectSQLParser.FIELDS - 308))
                            | (1 << (SelectSQLParser.FILE_BLOCK_SIZE - 308))
                            | (1 << (SelectSQLParser.FILTER - 308))
                            | (1 << (SelectSQLParser.FIRST - 308))
                            | (1 << (SelectSQLParser.FIXED - 308))
                            | (1 << (SelectSQLParser.FOLLOWS - 308))
                            | (1 << (SelectSQLParser.FULL - 308))
                            | (1 << (SelectSQLParser.FUNCTION - 308))
                            | (1 << (SelectSQLParser.GLOBAL - 308))
                            | (1 << (SelectSQLParser.GRANTS - 308))
                            | (1 << (SelectSQLParser.GROUP_REPLICATION - 308))
                            | (1 << (SelectSQLParser.HASH - 308))
                            | (1 << (SelectSQLParser.HOST - 308))
                            | (1 << (SelectSQLParser.IDENTIFIED - 308))
                            | (1 << (SelectSQLParser.IGNORE_SERVER_IDS - 308))
                            | (1 << (SelectSQLParser.IMPORT - 308))
                            | (1 << (SelectSQLParser.INDEXES - 308))
                            | (1 << (SelectSQLParser.INITIAL_SIZE - 308))
                            | (1 << (SelectSQLParser.INPLACE - 308))
                            | (1 << (SelectSQLParser.INSERT_METHOD - 308))
                            | (1 << (SelectSQLParser.INSTANCE - 308))
                            | (1 << (SelectSQLParser.INVOKER - 308))
                            | (1 << (SelectSQLParser.IO - 308))
                            | (1 << (SelectSQLParser.IO_THREAD - 308))
                            | (1 << (SelectSQLParser.IPC - 308))
                            | (1 << (SelectSQLParser.ISOLATION - 308))
                            | (1 << (SelectSQLParser.ISSUER - 308))
                            | (1 << (SelectSQLParser.KEY_BLOCK_SIZE - 308))
                            | (1 << (SelectSQLParser.LANGUAGE - 308))
                            | (1 << (SelectSQLParser.LAST - 308))
                            | (1 << (SelectSQLParser.LEAVES - 308))
                            | (1 << (SelectSQLParser.LESS - 308))
                            | (1 << (SelectSQLParser.LEVEL - 308))
                            | (1 << (SelectSQLParser.LIST - 308))
                            | (1 << (SelectSQLParser.LOCAL - 308))
                            | (1 << (SelectSQLParser.LOGFILE - 308))
                            | (1 << (SelectSQLParser.LOGS - 308))
                            | (1 << (SelectSQLParser.MASTER - 308))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 372))
                        & (
                            (1 << (SelectSQLParser.MASTER_AUTO_POSITION - 372))
                            | (1 << (SelectSQLParser.MASTER_CONNECT_RETRY - 372))
                            | (1 << (SelectSQLParser.MASTER_DELAY - 372))
                            | (1 << (SelectSQLParser.MASTER_HEARTBEAT_PERIOD - 372))
                            | (1 << (SelectSQLParser.MASTER_HOST - 372))
                            | (1 << (SelectSQLParser.MASTER_LOG_FILE - 372))
                            | (1 << (SelectSQLParser.MASTER_LOG_POS - 372))
                            | (1 << (SelectSQLParser.MASTER_PASSWORD - 372))
                            | (1 << (SelectSQLParser.MASTER_PORT - 372))
                            | (1 << (SelectSQLParser.MASTER_RETRY_COUNT - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CA - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CAPATH - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CERT - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CIPHER - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CRL - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_CRLPATH - 372))
                            | (1 << (SelectSQLParser.MASTER_SSL_KEY - 372))
                            | (1 << (SelectSQLParser.MASTER_TLS_VERSION - 372))
                            | (1 << (SelectSQLParser.MASTER_USER - 372))
                            | (1 << (SelectSQLParser.MAX_CONNECTIONS_PER_HOUR - 372))
                            | (1 << (SelectSQLParser.MAX_QUERIES_PER_HOUR - 372))
                            | (1 << (SelectSQLParser.MAX_ROWS - 372))
                            | (1 << (SelectSQLParser.MAX_SIZE - 372))
                            | (1 << (SelectSQLParser.MAX_UPDATES_PER_HOUR - 372))
                            | (1 << (SelectSQLParser.MAX_USER_CONNECTIONS - 372))
                            | (1 << (SelectSQLParser.MERGE - 372))
                            | (1 << (SelectSQLParser.MID - 372))
                            | (1 << (SelectSQLParser.MIGRATE - 372))
                            | (1 << (SelectSQLParser.MIN_ROWS - 372))
                            | (1 << (SelectSQLParser.MODIFY - 372))
                            | (1 << (SelectSQLParser.MUTEX - 372))
                            | (1 << (SelectSQLParser.MYSQL - 372))
                            | (1 << (SelectSQLParser.NAME - 372))
                            | (1 << (SelectSQLParser.NAMES - 372))
                            | (1 << (SelectSQLParser.NCHAR - 372))
                            | (1 << (SelectSQLParser.NEVER - 372))
                            | (1 << (SelectSQLParser.NO - 372))
                            | (1 << (SelectSQLParser.NODEGROUP - 372))
                            | (1 << (SelectSQLParser.NONE - 372))
                            | (1 << (SelectSQLParser.OFFLINE - 372))
                            | (1 << (SelectSQLParser.OFFSET - 372))
                            | (1 << (SelectSQLParser.OJ - 372))
                            | (1 << (SelectSQLParser.OLD_PASSWORD - 372))
                            | (1 << (SelectSQLParser.ONE - 372))
                            | (1 << (SelectSQLParser.ONLINE - 372))
                            | (1 << (SelectSQLParser.ONLY - 372))
                            | (1 << (SelectSQLParser.OPTIMIZER_COSTS - 372))
                            | (1 << (SelectSQLParser.OPTIONS - 372))
                            | (1 << (SelectSQLParser.OWNER - 372))
                            | (1 << (SelectSQLParser.PACK_KEYS - 372))
                            | (1 << (SelectSQLParser.PAGE - 372))
                            | (1 << (SelectSQLParser.PARSER - 372))
                            | (1 << (SelectSQLParser.PARTIAL - 372))
                            | (1 << (SelectSQLParser.PARTITIONING - 372))
                            | (1 << (SelectSQLParser.PARTITIONS - 372))
                            | (1 << (SelectSQLParser.PASSWORD - 372))
                            | (1 << (SelectSQLParser.PHASE - 372))
                            | (1 << (SelectSQLParser.PLUGIN_DIR - 372))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 436))
                        & (
                            (1 << (SelectSQLParser.PLUGINS - 436))
                            | (1 << (SelectSQLParser.PORT - 436))
                            | (1 << (SelectSQLParser.PRECEDES - 436))
                            | (1 << (SelectSQLParser.PREPARE - 436))
                            | (1 << (SelectSQLParser.PRESERVE - 436))
                            | (1 << (SelectSQLParser.PREV - 436))
                            | (1 << (SelectSQLParser.PROCESSLIST - 436))
                            | (1 << (SelectSQLParser.PROFILE - 436))
                            | (1 << (SelectSQLParser.PROFILES - 436))
                            | (1 << (SelectSQLParser.PROXY - 436))
                            | (1 << (SelectSQLParser.QUERY - 436))
                            | (1 << (SelectSQLParser.QUICK - 436))
                            | (1 << (SelectSQLParser.REBUILD - 436))
                            | (1 << (SelectSQLParser.RECOVER - 436))
                            | (1 << (SelectSQLParser.REDO_BUFFER_SIZE - 436))
                            | (1 << (SelectSQLParser.REDUNDANT - 436))
                            | (1 << (SelectSQLParser.RELAY_LOG_FILE - 436))
                            | (1 << (SelectSQLParser.RELAY_LOG_POS - 436))
                            | (1 << (SelectSQLParser.RELAYLOG - 436))
                            | (1 << (SelectSQLParser.REMOVE - 436))
                            | (1 << (SelectSQLParser.REORGANIZE - 436))
                            | (1 << (SelectSQLParser.REPAIR - 436))
                            | (1 << (SelectSQLParser.REPLICATE_DO_DB - 436))
                            | (1 << (SelectSQLParser.REPLICATE_DO_TABLE - 436))
                            | (1 << (SelectSQLParser.REPLICATE_IGNORE_DB - 436))
                            | (1 << (SelectSQLParser.REPLICATE_IGNORE_TABLE - 436))
                            | (1 << (SelectSQLParser.REPLICATE_REWRITE_DB - 436))
                            | (1 << (SelectSQLParser.REPLICATE_WILD_DO_TABLE - 436))
                            | (1 << (SelectSQLParser.REPLICATE_WILD_IGNORE_TABLE - 436))
                            | (1 << (SelectSQLParser.REPLICATION - 436))
                            | (1 << (SelectSQLParser.RESUME - 436))
                            | (1 << (SelectSQLParser.RETURNS - 436))
                            | (1 << (SelectSQLParser.ROLLBACK - 436))
                            | (1 << (SelectSQLParser.ROLLUP - 436))
                            | (1 << (SelectSQLParser.ROTATE - 436))
                            | (1 << (SelectSQLParser.ROW - 436))
                            | (1 << (SelectSQLParser.ROWS - 436))
                            | (1 << (SelectSQLParser.ROW_FORMAT - 436))
                            | (1 << (SelectSQLParser.SAVEPOINT - 436))
                            | (1 << (SelectSQLParser.SCHEDULE - 436))
                            | (1 << (SelectSQLParser.SECURITY - 436))
                            | (1 << (SelectSQLParser.SERVER - 436))
                            | (1 << (SelectSQLParser.SESSION - 436))
                            | (1 << (SelectSQLParser.SHARE - 436))
                            | (1 << (SelectSQLParser.SHARED - 436))
                            | (1 << (SelectSQLParser.SIGNED - 436))
                            | (1 << (SelectSQLParser.SIMPLE - 436))
                            | (1 << (SelectSQLParser.SLAVE - 436))
                            | (1 << (SelectSQLParser.SNAPSHOT - 436))
                            | (1 << (SelectSQLParser.SOCKET - 436))
                            | (1 << (SelectSQLParser.SOME - 436))
                            | (1 << (SelectSQLParser.SOUNDS - 436))
                            | (1 << (SelectSQLParser.SOURCE - 436))
                            | (1 << (SelectSQLParser.SQL_AFTER_GTIDS - 436))
                            | (1 << (SelectSQLParser.SQL_AFTER_MTS_GAPS - 436))
                            | (1 << (SelectSQLParser.SQL_BEFORE_GTIDS - 436))
                            | (1 << (SelectSQLParser.SQL_BUFFER_RESULT - 436))
                            | (1 << (SelectSQLParser.SQL_CACHE - 436))
                            | (1 << (SelectSQLParser.SQL_NO_CACHE - 436))
                            | (1 << (SelectSQLParser.SQL_THREAD - 436))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 500))
                        & (
                            (1 << (SelectSQLParser.START - 500))
                            | (1 << (SelectSQLParser.STARTS - 500))
                            | (1 << (SelectSQLParser.STATS_AUTO_RECALC - 500))
                            | (1 << (SelectSQLParser.STATS_PERSISTENT - 500))
                            | (1 << (SelectSQLParser.STATS_SAMPLE_PAGES - 500))
                            | (1 << (SelectSQLParser.STATUS - 500))
                            | (1 << (SelectSQLParser.STOP - 500))
                            | (1 << (SelectSQLParser.STORAGE - 500))
                            | (1 << (SelectSQLParser.STRING - 500))
                            | (1 << (SelectSQLParser.SUBJECT - 500))
                            | (1 << (SelectSQLParser.SUBPARTITION - 500))
                            | (1 << (SelectSQLParser.SUBPARTITIONS - 500))
                            | (1 << (SelectSQLParser.SUSPEND - 500))
                            | (1 << (SelectSQLParser.SWAPS - 500))
                            | (1 << (SelectSQLParser.SWITCHES - 500))
                            | (1 << (SelectSQLParser.TABLESPACE - 500))
                            | (1 << (SelectSQLParser.TEMPORARY - 500))
                            | (1 << (SelectSQLParser.TEMPTABLE - 500))
                            | (1 << (SelectSQLParser.THAN - 500))
                            | (1 << (SelectSQLParser.TRANSACTION - 500))
                            | (1 << (SelectSQLParser.TRUNCATE - 500))
                            | (1 << (SelectSQLParser.UNDEFINED - 500))
                            | (1 << (SelectSQLParser.UNDOFILE - 500))
                            | (1 << (SelectSQLParser.UNDO_BUFFER_SIZE - 500))
                            | (1 << (SelectSQLParser.UNKNOWN - 500))
                            | (1 << (SelectSQLParser.UPGRADE - 500))
                            | (1 << (SelectSQLParser.USER - 500))
                            | (1 << (SelectSQLParser.VALIDATION - 500))
                            | (1 << (SelectSQLParser.VALUE - 500))
                            | (1 << (SelectSQLParser.VARIABLES - 500))
                            | (1 << (SelectSQLParser.VIEW - 500))
                            | (1 << (SelectSQLParser.WAIT - 500))
                            | (1 << (SelectSQLParser.WARNINGS - 500))
                            | (1 << (SelectSQLParser.WITHOUT - 500))
                            | (1 << (SelectSQLParser.WORK - 500))
                            | (1 << (SelectSQLParser.WRAPPER - 500))
                            | (1 << (SelectSQLParser.X509 - 500))
                            | (1 << (SelectSQLParser.XA - 500))
                            | (1 << (SelectSQLParser.XML - 500))
                        )
                    )
                    != 0
                )
                or _la == SelectSQLParser.MEMORY
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
    ...
    def functionNameBase(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                _la == SelectSQLParser.LEFT
                or _la == SelectSQLParser.RIGHT
                or (
                    (((_la - 180)) & ~0x3F) == 0
                    and (
                        (1 << (_la - 180))
                        & (
                            ...
                            | (1 << (SelectSQLParser.TIMESTAMP - 180))
                            | (1 << (SelectSQLParser.YEAR - 180))
                            | (1 << (SelectSQLParser.COUNT - 180))
                            | (1 << (SelectSQLParser.POSITION - 180))
                        )
                    )
                    != 0
                )
                ...
                or (
                    ...
                    and (
                        ...
                        & (
                            ...
                            | (1 << (SelectSQLParser.POINT - 622))
                            | (1 << (SelectSQLParser.POLYGON - 622))
                            | (1 << (SelectSQLParser.ABS - 622))
                            | (1 << (SelectSQLParser.ACOS - 622))
                            | (1 << (SelectSQLParser.ADDDATE - 622))
                            | (1 << (SelectSQLParser.ADDTIME - 622))
                            | (1 << (SelectSQLParser.AES_DECRYPT - 622))
                            | (1 << (SelectSQLParser.AES_ENCRYPT - 622))
                            | (1 << (SelectSQLParser.AREA - 622))
                            | (1 << (SelectSQLParser.ASBINARY - 622))
                            | (1 << (SelectSQLParser.ASIN - 622))
                            | (1 << (SelectSQLParser.ASTEXT - 622))
                            | (1 << (SelectSQLParser.ASWKB - 622))
                            | (1 << (SelectSQLParser.ASWKT - 622))
                            | (1 << (SelectSQLParser.ASYMMETRIC_DECRYPT - 622))
                            | (1 << (SelectSQLParser.ASYMMETRIC_DERIVE - 622))
                            | (1 << (SelectSQLParser.ASYMMETRIC_ENCRYPT - 622))
                            | (1 << (SelectSQLParser.ASYMMETRIC_SIGN - 622))
                            | (1 << (SelectSQLParser.ASYMMETRIC_VERIFY - 622))
                            | (1 << (SelectSQLParser.ATAN - 622))
                            | (1 << (SelectSQLParser.ATAN2 - 622))
                            | (1 << (SelectSQLParser.BENCHMARK - 622))
                            | (1 << (SelectSQLParser.BIN - 622))
                            | (1 << (SelectSQLParser.BIT_COUNT - 622))
                            | (1 << (SelectSQLParser.BIT_LENGTH - 622))
                            | (1 << (SelectSQLParser.BUFFER - 622))
                            | (1 << (SelectSQLParser.CEIL - 622))
                            | (1 << (SelectSQLParser.CEILING - 622))
                            | (1 << (SelectSQLParser.CENTROID - 622))
                            | (1 << (SelectSQLParser.CHARACTER_LENGTH - 622))
                            | (1 << (SelectSQLParser.CHARSET - 622))
                            | (1 << (SelectSQLParser.CHAR_LENGTH - 622))
                            | (1 << (SelectSQLParser.COERCIBILITY - 622))
                            | (1 << (SelectSQLParser.COLLATION - 622))
                            | (1 << (SelectSQLParser.COMPRESS - 622))
                            | (1 << (SelectSQLParser.CONCAT - 622))
                            | (1 << (SelectSQLParser.CONCAT_WS - 622))
                            | (1 << (SelectSQLParser.CONNECTION_ID - 622))
                            | (1 << (SelectSQLParser.CONV - 622))
                            | (1 << (SelectSQLParser.CONVERT_TZ - 622))
                            | (1 << (SelectSQLParser.COS - 622))
                            | (1 << (SelectSQLParser.COT - 622))
                            | (1 << (SelectSQLParser.CRC32 - 622))
                            | (1 << (SelectSQLParser.CREATE_ASYMMETRIC_PRIV_KEY - 622))
                            | (1 << (SelectSQLParser.CREATE_ASYMMETRIC_PUB_KEY - 622))
                            | (1 << (SelectSQLParser.CREATE_DH_PARAMETERS - 622))
                            | (1 << (SelectSQLParser.CREATE_DIGEST - 622))
                            | (1 << (SelectSQLParser.CROSSES - 622))
                            | (1 << (SelectSQLParser.DATEDIFF - 622))
                            | (1 << (SelectSQLParser.DATE_FORMAT - 622))
                            | (1 << (SelectSQLParser.DAYNAME - 622))
                            | (1 << (SelectSQLParser.DAYOFMONTH - 622))
                            | (1 << (SelectSQLParser.DAYOFWEEK - 622))
                            | (1 << (SelectSQLParser.DAYOFYEAR - 622))
                            | (1 << (SelectSQLParser.DECODE - 622))
                            | (1 << (SelectSQLParser.DEGREES - 622))
                            | (1 << (SelectSQLParser.DES_DECRYPT - 622))
                            | (1 << (SelectSQLParser.DES_ENCRYPT - 622))
                            | (1 << (SelectSQLParser.DIMENSION - 622))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 686))
                        & (
                            (1 << (SelectSQLParser.DISJOINT - 686))
                            | (1 << (SelectSQLParser.ELT - 686))
                            | (1 << (SelectSQLParser.ENCODE - 686))
                            | (1 << (SelectSQLParser.ENCRYPT - 686))
                            | (1 << (SelectSQLParser.ENDPOINT - 686))
                            | (1 << (SelectSQLParser.ENVELOPE - 686))
                            | (1 << (SelectSQLParser.EQUALS - 686))
                            | (1 << (SelectSQLParser.EXP - 686))
                            | (1 << (SelectSQLParser.EXPORT_SET - 686))
                            | (1 << (SelectSQLParser.EXTERIORRING - 686))
                            | (1 << (SelectSQLParser.EXTRACTVALUE - 686))
                            | (1 << (SelectSQLParser.FIELD - 686))
                            | (1 << (SelectSQLParser.FIND_IN_SET - 686))
                            | (1 << (SelectSQLParser.FLOOR - 686))
                            | (1 << (SelectSQLParser.FORMAT - 686))
                            | (1 << (SelectSQLParser.FOUND_ROWS - 686))
                            | (1 << (SelectSQLParser.FROM_BASE64 - 686))
                            | (1 << (SelectSQLParser.FROM_DAYS - 686))
                            | (1 << (SelectSQLParser.FROM_UNIXTIME - 686))
                            | (1 << (SelectSQLParser.GEOMCOLLFROMTEXT - 686))
                            | (1 << (SelectSQLParser.GEOMCOLLFROMWKB - 686))
                            | (1 << (SelectSQLParser.GEOMETRYCOLLECTIONFROMTEXT - 686))
                            | (1 << (SelectSQLParser.GEOMETRYCOLLECTIONFROMWKB - 686))
                            | (1 << (SelectSQLParser.GEOMETRYFROMTEXT - 686))
                            | (1 << (SelectSQLParser.GEOMETRYFROMWKB - 686))
                            | (1 << (SelectSQLParser.GEOMETRYN - 686))
                            | (1 << (SelectSQLParser.GEOMETRYTYPE - 686))
                            | (1 << (SelectSQLParser.GEOMFROMTEXT - 686))
                            | (1 << (SelectSQLParser.GEOMFROMWKB - 686))
                            | (1 << (SelectSQLParser.GET_FORMAT - 686))
                            | (1 << (SelectSQLParser.GET_LOCK - 686))
                            | (1 << (SelectSQLParser.GLENGTH - 686))
                            | (1 << (SelectSQLParser.GREATEST - 686))
                            | (1 << (SelectSQLParser.GTID_SUBSET - 686))
                            | (1 << (SelectSQLParser.GTID_SUBTRACT - 686))
                            | (1 << (SelectSQLParser.HEX - 686))
                            | (1 << (SelectSQLParser.IFNULL - 686))
                            | (1 << (SelectSQLParser.INET6_ATON - 686))
                            | (1 << (SelectSQLParser.INET6_NTOA - 686))
                            | (1 << (SelectSQLParser.INET_ATON - 686))
                            | (1 << (SelectSQLParser.INET_NTOA - 686))
                            | (1 << (SelectSQLParser.INSTR - 686))
                            | (1 << (SelectSQLParser.INTERIORRINGN - 686))
                            | (1 << (SelectSQLParser.INTERSECTS - 686))
                            | (1 << (SelectSQLParser.ISCLOSED - 686))
                            | (1 << (SelectSQLParser.ISEMPTY - 686))
                            | (1 << (SelectSQLParser.ISNULL - 686))
                            | (1 << (SelectSQLParser.ISSIMPLE - 686))
                            | (1 << (SelectSQLParser.IS_FREE_LOCK - 686))
                            | (1 << (SelectSQLParser.IS_IPV4 - 686))
                            | (1 << (SelectSQLParser.IS_IPV4_COMPAT - 686))
                            | (1 << (SelectSQLParser.IS_IPV4_MAPPED - 686))
                            | (1 << (SelectSQLParser.IS_IPV6 - 686))
                            | (1 << (SelectSQLParser.IS_USED_LOCK - 686))
                            | (1 << (SelectSQLParser.LAST_INSERT_ID - 686))
                            | (1 << (SelectSQLParser.LCASE - 686))
                            | (1 << (SelectSQLParser.LEAST - 686))
                            | (1 << (SelectSQLParser.LENGTH - 686))
                            | (1 << (SelectSQLParser.LINEFROMTEXT - 686))
                            | (1 << (SelectSQLParser.LINEFROMWKB - 686))
                            | (1 << (SelectSQLParser.LINESTRINGFROMTEXT - 686))
                            | (1 << (SelectSQLParser.LINESTRINGFROMWKB - 686))
                            | (1 << (SelectSQLParser.LN - 686))
                            | (1 << (SelectSQLParser.LOAD_FILE - 686))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 750))
                        & (
                            (1 << (SelectSQLParser.LOCATE - 750))
                            | (1 << (SelectSQLParser.LOG - 750))
                            | (1 << (SelectSQLParser.LOG10 - 750))
                            | (1 << (SelectSQLParser.LOG2 - 750))
                            | (1 << (SelectSQLParser.LOWER - 750))
                            | (1 << (SelectSQLParser.LPAD - 750))
                            | (1 << (SelectSQLParser.LTRIM - 750))
                            | (1 << (SelectSQLParser.MAKEDATE - 750))
                            | (1 << (SelectSQLParser.MAKETIME - 750))
                            | (1 << (SelectSQLParser.MAKE_SET - 750))
                            | (1 << (SelectSQLParser.MASTER_POS_WAIT - 750))
                            | (1 << (SelectSQLParser.MBRCONTAINS - 750))
                            | (1 << (SelectSQLParser.MBRDISJOINT - 750))
                            | (1 << (SelectSQLParser.MBREQUAL - 750))
                            | (1 << (SelectSQLParser.MBRINTERSECTS - 750))
                            | (1 << (SelectSQLParser.MBROVERLAPS - 750))
                            | (1 << (SelectSQLParser.MBRTOUCHES - 750))
                            | (1 << (SelectSQLParser.MBRWITHIN - 750))
                            | (1 << (SelectSQLParser.MD5 - 750))
                            | (1 << (SelectSQLParser.MLINEFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MLINEFROMWKB - 750))
                            | (1 << (SelectSQLParser.MONTHNAME - 750))
                            | (1 << (SelectSQLParser.MPOINTFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MPOINTFROMWKB - 750))
                            | (1 << (SelectSQLParser.MPOLYFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MPOLYFROMWKB - 750))
                            | (1 << (SelectSQLParser.MULTILINESTRINGFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MULTILINESTRINGFROMWKB - 750))
                            | (1 << (SelectSQLParser.MULTIPOINTFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MULTIPOINTFROMWKB - 750))
                            | (1 << (SelectSQLParser.MULTIPOLYGONFROMTEXT - 750))
                            | (1 << (SelectSQLParser.MULTIPOLYGONFROMWKB - 750))
                            | (1 << (SelectSQLParser.NAME_CONST - 750))
                            | (1 << (SelectSQLParser.NULLIF - 750))
                            | (1 << (SelectSQLParser.NUMGEOMETRIES - 750))
                            | (1 << (SelectSQLParser.NUMINTERIORRINGS - 750))
                            | (1 << (SelectSQLParser.NUMPOINTS - 750))
                            | (1 << (SelectSQLParser.OCT - 750))
                            | (1 << (SelectSQLParser.OCTET_LENGTH - 750))
                            | (1 << (SelectSQLParser.ORD - 750))
                            | (1 << (SelectSQLParser.OVERLAPS - 750))
                            | (1 << (SelectSQLParser.PERIOD_ADD - 750))
                            | (1 << (SelectSQLParser.PERIOD_DIFF - 750))
                            | (1 << (SelectSQLParser.PI - 750))
                            | (1 << (SelectSQLParser.POINTFROMTEXT - 750))
                            | (1 << (SelectSQLParser.POINTFROMWKB - 750))
                            | (1 << (SelectSQLParser.POINTN - 750))
                            | (1 << (SelectSQLParser.POLYFROMTEXT - 750))
                            | (1 << (SelectSQLParser.POLYFROMWKB - 750))
                            | (1 << (SelectSQLParser.POLYGONFROMTEXT - 750))
                            | (1 << (SelectSQLParser.POLYGONFROMWKB - 750))
                            | (1 << (SelectSQLParser.POW - 750))
                            | (1 << (SelectSQLParser.POWER - 750))
                            | (1 << (SelectSQLParser.QUOTE - 750))
                            | (1 << (SelectSQLParser.RADIANS - 750))
                            | (1 << (SelectSQLParser.RAND - 750))
                            | (1 << (SelectSQLParser.RANDOM_BYTES - 750))
                            | (1 << (SelectSQLParser.RELEASE_LOCK - 750))
                            | (1 << (SelectSQLParser.REVERSE - 750))
                            | (1 << (SelectSQLParser.ROUND - 750))
                            | (1 << (SelectSQLParser.ROW_COUNT - 750))
                            | (1 << (SelectSQLParser.RPAD - 750))
                            | (1 << (SelectSQLParser.RTRIM - 750))
                            | (1 << (SelectSQLParser.SEC_TO_TIME - 750))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 814))
                        & (
                            (1 << (SelectSQLParser.SESSION_USER - 814))
                            | (1 << (SelectSQLParser.SHA - 814))
                            | (1 << (SelectSQLParser.SHA1 - 814))
                            | (1 << (SelectSQLParser.SHA2 - 814))
                            | (1 << (SelectSQLParser.SIGN - 814))
                            | (1 << (SelectSQLParser.SIN - 814))
                            | (1 << (SelectSQLParser.SLEEP - 814))
                            | (1 << (SelectSQLParser.SOUNDEX - 814))
                            | (1 << (SelectSQLParser.SQL_THREAD_WAIT_AFTER_GTIDS - 814))
                            | (1 << (SelectSQLParser.SQRT - 814))
                            | (1 << (SelectSQLParser.SRID - 814))
                            | (1 << (SelectSQLParser.STARTPOINT - 814))
                            | (1 << (SelectSQLParser.STRCMP - 814))
                            | (1 << (SelectSQLParser.STR_TO_DATE - 814))
                            | (1 << (SelectSQLParser.ST_AREA - 814))
                            | (1 << (SelectSQLParser.ST_ASBINARY - 814))
                            | (1 << (SelectSQLParser.ST_ASTEXT - 814))
                            | (1 << (SelectSQLParser.ST_ASWKB - 814))
                            | (1 << (SelectSQLParser.ST_ASWKT - 814))
                            | (1 << (SelectSQLParser.ST_BUFFER - 814))
                            | (1 << (SelectSQLParser.ST_CENTROID - 814))
                            | (1 << (SelectSQLParser.ST_CONTAINS - 814))
                            | (1 << (SelectSQLParser.ST_CROSSES - 814))
                            | (1 << (SelectSQLParser.ST_DIFFERENCE - 814))
                            | (1 << (SelectSQLParser.ST_DIMENSION - 814))
                            | (1 << (SelectSQLParser.ST_DISJOINT - 814))
                            | (1 << (SelectSQLParser.ST_DISTANCE - 814))
                            | (1 << (SelectSQLParser.ST_ENDPOINT - 814))
                            | (1 << (SelectSQLParser.ST_ENVELOPE - 814))
                            | (1 << (SelectSQLParser.ST_EQUALS - 814))
                            | (1 << (SelectSQLParser.ST_EXTERIORRING - 814))
                            | (1 << (SelectSQLParser.ST_GEOMCOLLFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_GEOMCOLLFROMTXT - 814))
                            | (1 << (SelectSQLParser.ST_GEOMCOLLFROMWKB - 814))
                            | (
                                1
                                << (SelectSQLParser.ST_GEOMETRYCOLLECTIONFROMTEXT - 814)
                            )
                            | (
                                1
                                << (SelectSQLParser.ST_GEOMETRYCOLLECTIONFROMWKB - 814)
                            )
                            | (1 << (SelectSQLParser.ST_GEOMETRYFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_GEOMETRYFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_GEOMETRYN - 814))
                            | (1 << (SelectSQLParser.ST_GEOMETRYTYPE - 814))
                            | (1 << (SelectSQLParser.ST_GEOMFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_GEOMFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_INTERIORRINGN - 814))
                            | (1 << (SelectSQLParser.ST_INTERSECTION - 814))
                            | (1 << (SelectSQLParser.ST_INTERSECTS - 814))
                            | (1 << (SelectSQLParser.ST_ISCLOSED - 814))
                            | (1 << (SelectSQLParser.ST_ISEMPTY - 814))
                            | (1 << (SelectSQLParser.ST_ISSIMPLE - 814))
                            | (1 << (SelectSQLParser.ST_LINEFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_LINEFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_LINESTRINGFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_LINESTRINGFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_NUMGEOMETRIES - 814))
                            | (1 << (SelectSQLParser.ST_NUMINTERIORRING - 814))
                            | (1 << (SelectSQLParser.ST_NUMINTERIORRINGS - 814))
                            | (1 << (SelectSQLParser.ST_NUMPOINTS - 814))
                            | (1 << (SelectSQLParser.ST_OVERLAPS - 814))
                            | (1 << (SelectSQLParser.ST_POINTFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_POINTFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_POINTN - 814))
                            | (1 << (SelectSQLParser.ST_POLYFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_POLYFROMWKB - 814))
                            | (1 << (SelectSQLParser.ST_POLYGONFROMTEXT - 814))
                            | (1 << (SelectSQLParser.ST_POLYGONFROMWKB - 814))
                        )
                    )
                    != 0
                )
                or (
                    ...
                    and (
                        (1 << (_la - 878))
                        & (
                            (1 << (SelectSQLParser.ST_SRID - 878))
                            | (1 << (SelectSQLParser.ST_STARTPOINT - 878))
                            | (1 << (SelectSQLParser.ST_SYMDIFFERENCE - 878))
                            | (1 << (SelectSQLParser.ST_TOUCHES - 878))
                            | (1 << (SelectSQLParser.ST_UNION - 878))
                            | (1 << (SelectSQLParser.ST_WITHIN - 878))
                            | (1 << (SelectSQLParser.ST_X - 878))
                            | (1 << (SelectSQLParser.ST_Y - 878))
                            | (1 << (SelectSQLParser.SUBDATE - 878))
                            | (1 << (SelectSQLParser.SUBSTRING_INDEX - 878))
                            | (1 << (SelectSQLParser.SUBTIME - 878))
                            | (1 << (SelectSQLParser.SYSTEM_USER - 878))
                            | (1 << (SelectSQLParser.TAN - 878))
                            | (1 << (SelectSQLParser.TIMEDIFF - 878))
                            | (1 << (SelectSQLParser.TIMESTAMPADD - 878))
                            | (1 << (SelectSQLParser.TIMESTAMPDIFF - 878))
                            | (1 << (SelectSQLParser.TIME_FORMAT - 878))
                            | (1 << (SelectSQLParser.TIME_TO_SEC - 878))
                            | (1 << (SelectSQLParser.TOUCHES - 878))
                            | (1 << (SelectSQLParser.TO_BASE64 - 878))
                            | (1 << (SelectSQLParser.TO_DAYS - 878))
                            | (1 << (SelectSQLParser.TO_SECONDS - 878))
                            | (1 << (SelectSQLParser.UCASE - 878))
                            | (1 << (SelectSQLParser.UNCOMPRESS - 878))
                            | (1 << (SelectSQLParser.UNCOMPRESSED_LENGTH - 878))
                            | (1 << (SelectSQLParser.UNHEX - 878))
                            | (1 << (SelectSQLParser.UNIX_TIMESTAMP - 878))
                            | (1 << (SelectSQLParser.UPDATEXML - 878))
                            | (1 << (SelectSQLParser.UPPER - 878))
                            | (1 << (SelectSQLParser.UUID - 878))
                            | (1 << (SelectSQLParser.UUID_SHORT - 878))
                            | (1 << (SelectSQLParser.VALIDATE_PASSWORD_STRENGTH - 878))
                            | (1 << (SelectSQLParser.VERSION - 878))
                            | (
                                1
                                << (
                                    SelectSQLParser.WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS
                            ...
                            | (1 << (SelectSQLParser.WEEKDAY - 878))
                            | (1 << (SelectSQLParser.WEEKOFYEAR - 878))
                            | (1 << (SelectSQLParser.WEIGHT_STRING - 878))
                            | (1 << (SelectSQLParser.WITHIN - 878))
                            | (1 << (SelectSQLParser.YEARWEEK - 878))
                            | (1 << (SelectSQLParser.Y_FUNCTION - 878))
                            | (1 << (SelectSQLParser.X_FUNCTION - 878))
                        )
                    )
                    != 0
                )
