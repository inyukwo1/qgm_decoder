...
def eval_where(pred, label):
    ...
    print(
        "pred_total: {}, label_total: {}, cnt: {}, cnt_wo_op: {}, cnt_wn: {}, cnt_where: {}".format(
            pred_total, label_total, cnt, cnt_wo_agg, cnt_wn, cnt_where
        )
    )
...
class Evaluator:
    ...
    def eval_partial_match(self, pred, label):
        ...
        res["where(#conditions)"] = {
            ...
            "rec": rec,
            "f1": f1,
            "label_total": where_label_total,
            "pred_total": where_pred_total,
        }
