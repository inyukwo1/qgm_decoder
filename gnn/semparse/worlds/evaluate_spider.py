...
import json
from gnn.semparse.worlds.evaluate import Evaluator, build_valid_col_units, rebuild_sql_val, rebuild_sql_col, \
...
def evaluate(gold, predict, db_name, db_dir, table, check_valid: bool=True) -> bool:
    ...
    if tables_JSON is None:
        ...
        for db in data:
           ...
           tables_JSON[db_id] = {'column_names_original': column_names_original,
