...
GRAMMAR_DICTIONARY["join_clause"] = [
    ...
    '("inner" ws "join" ws table_source ws "on" ws join_condition_clause)',
]
...
GRAMMAR_DICTIONARY["non_literal_numbers"] = [
    '(ws non_literal_number ws "," ws non_literal_numbers)',
    "(ws non_literal_number)",
]
...
GRAMMAR_DICTIONARY["where_conds"] = [
    "(ws where_conj ws where_conj_op wsp where_conds)",
    "(ws where_conj)",
]
