...
from gnn.dataset_readers.dataset_util.spider_utils import Table
...
GRAMMAR_DICTIONARY["join_clause"] = ['("join" ws table_source ws "on" ws join_condition_clause)', '("inner" ws "join" ws table_source ws "on" ws join_condition_clause)']
...
GRAMMAR_DICTIONARY["limit"] = ['("limit" ws non_literal_numbers)']
GRAMMAR_DICTIONARY["non_literal_numbers"] = ['(ws non_literal_number ws "," ws non_literal_numbers)', '(ws non_literal_number)']


#GRAMMAR_DICTIONARY["where_clause_no_parenthesize"] = ['(ws "where" wsp expr ws where_conj_no_parenthesize)', '(ws "where" wsp expr)']
GRAMMAR_DICTIONARY["where_clause"] = ['(ws "where" ws where_conds)']
GRAMMAR_DICTIONARY["where_conds"] = ['(ws where_conj ws where_conj_op wsp where_conds)', '(ws where_conj)']
GRAMMAR_DICTIONARY["where_conj"] = [
               # ( A )
               '(ws "(" ws where_conds ws ")")',
               # A
               '(ws expr)']
#GRAMMAR_DICTIONARY["where_conj_no_parenthesize"] = ['(ws where_conj_op wsp expr ws where_conj_no_parenthesize)', '(ws where_conj_op wsp expr)']

GRAMMAR_DICTIONARY["where_conj_op"] = ['"and"', '"or"']
...
GRAMMAR_DICTIONARY["expr"] = ['in_expr',
                              ...
                              '(value wsp "not" wsp "like" wsp string)',
                              # Between expressions.
                              '(value ws "between" wsp value ws "and" wsp value)',
                              # Between expressions.
                              '(value ws "is" wsp "null")',
                              # Binary expressions.
...
GRAMMAR_DICTIONARY["non_literal_number"] = ['"0"', '"1"', '"2"', '"3"', '"4"', '"5"', '"10"']
