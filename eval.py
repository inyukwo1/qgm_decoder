...
def evaluate(cfg):
    ...
    if True:
        dev_total_acc, dev_is_correct, dev_pred, dev_gold, dev_list = utils.epoch_acc(model, cfg.batch_size, val_data, cfg.decoder_name,)
        ...
        print("total acc : {}".format(dev_total_acc))
    else:
