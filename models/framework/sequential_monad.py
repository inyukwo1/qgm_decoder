from typing import Callable, Type, Dict, Union, NewType, List
from abc import ABC
from models.framework.promise import TensorPromise
from models.framework.lazy_modules import LazyModule
import torch
