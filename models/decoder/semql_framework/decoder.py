...
from rule.grammar import Action
...
from models.decoder.semql_framework.state import (
    LSTMStateGold,
    LSTMStatePred,
    LSTMState,
)
...
class SemQLDecoderFramework(nn.Module):
    ...
    def forward(
        ...
        def pass_sketch_lstm_cell(
            ...
            next_lstm_state = self.sketch_lstm_cell.forward_later(
                combined_input, lstm_state
            )
        ...
        def calc_detail_prob(
            ...
            if cur_symbol == "C":
                ...
                masked_encoded_tab[possible_table_ids] = state.encoded_tab[
                    possible_table_ids
                ]
                att_emb = state.get_att_emb()
                tab_probs = self.table_pointer_net.forward_later(
                    masked_encoded_tab, att_emb
                )
