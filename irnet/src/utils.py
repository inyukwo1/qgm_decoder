...
def schema_linking(
    question_arg, question_arg_type, one_hot_type, col_set_type, col_set_iter, sql
):
...
def load_dataset(dataset_dir, use_small=False, use_eval_only=False):
