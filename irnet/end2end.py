...
from irnet.src.utils import process, schema_linking, get_col_table_dict, get_table_colNames
from irnet.src.dataset import Example
from irnet.sem2SQL import transform
from irnet.src.rule.sem_utils import alter_not_in_one_entry, alter_column0_one_entry, alter_inter_one_entry
import torch
import json
import re
import sqlite3
...
class End2EndIRNet(End2End):
    def prepare_model(self, dataset):
        ...
        _, _, val_sql_data, val_table_data = utils.load_dataset("data/{}".format(dataset), use_eval_only=True)
